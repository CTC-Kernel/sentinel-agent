...
const AppLayout: React.FC = () => {
    ...
    return (
        <div className="flex h-[100dvh] overflow-hidden bg-background text-foreground font-sans relative selection:bg-primary/30 selection:text-primary transition-colors duration-300 pb-safe">
            ...
            {!isOnline && (
                <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-tooltip glass-panel px-4 py-2 rounded-full flex items-center text-xs font-medium text-slate-600 dark:text-slate-400 shadow-lg animate-slide-up border border-slate-200 dark:border-slate-700">
            ...
            <div className="flex-1 min-w-0 flex flex-col overflow-hidden relative z-decorator">
                ...
                <SmoothScroll
                    ...
                    className={`flex-1 min-w-0 ${mobileOpen ? 'overflow-hidden' : 'overflow-y-auto overflow-x-hidden scroll-smooth'} [scrollbar-gutter:stable] p-0`}
                >
