...
export class CMDBService {
  ...
  static async createCI(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la creation du CI');
      throw error;
    }
  }
  ...
  static async getCI(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la recuperation du CI');
      throw error;
    }
  }
  ...
  static async listCIs(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la liste des CIs');
      throw error;
    }
  }
  ...
  static async getCIByFingerprint(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la recherche par empreinte');
      throw error;
    }
  }
  ...
  static async updateCI(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la mise a jour du CI');
      throw error;
    }
  }
  ...
  static async updateDiscoveryTimestamp(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la MAJ du timestamp');
      throw error;
    }
  }
  ...
  static async deleteCI(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la suppression du CI');
      throw error;
    }
  }
  ...
  static async getDiscoveryStats(organizationId: string): Promise<DiscoveryStats> {
    try {
      ...
      const pending = pendingSnapshot.size;
        ...
        ErrorLogger.handleErrorWithToast(pendingError, 'Erreur lors de la récupération des validations en attente');
        throw pendingError;
      }
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la recuperation des stats');
      throw error;
    }
  }
  ...
  static async getRecentActivity(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la recuperation de l activite');
      throw error;
    }
  }
  ...
  static async logActivity(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de l enregistrement de l activite');
      throw error;
    }
  }
  ...
  static async getDailyActivityStats(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la recuperation des stats quotidiennes');
      throw error;
    }
  }
  ...
  static async getCIsByIds(
    ...
    try {
      ...
      ErrorLogger.handleErrorWithToast(error, 'Erreur lors de la recuperation des CIs par IDs');
      throw error;
    }
  }
