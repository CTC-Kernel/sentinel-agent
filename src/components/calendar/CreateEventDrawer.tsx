...
export const CreateEventDrawer: React.FC<CreateEventDrawerProps> = ({ isOpen, onClose, onEventCreated, initialDate }) => {
 ...
 <div className="space-y-6 max-w-5xl mx-auto w-full">
  ...
  {/* Event Type Toggle */}
  <div className="flex space-x-2 bg-muted/50 p-1.5 rounded-3xl">
  ...
  className={`flex-1 py-2.5 px-4 rounded-2xl text-sm font-medium transition-all capitalize ${eventType === type
   ...
   : 'text-muted-foreground hover:text-foreground/60 hover:bg-muted/500/50'
   }`}
  >
  ...
  <div>
  <div className="block text-sm font-medium text-foreground mb-2">{t('events.fields.startDate', { defaultValue: 'Date de début' })}</div>
  ...
  <div>
  <div className="block text-sm font-medium text-foreground mb-2">{t('events.fields.endDate', { defaultValue: 'Date de fin / Échéance' })}</div>
  <div className="flex gap-2">
  <div className="flex-1">
   <Controller
   name="end"
  ...
  type="checkbox"
  id="allDay"
  className="rounded border-border/40 text-primary focus-visible:ring-primary w-5 h-5"
  {...register('allDay')}
  />
  <label htmlFor="allDay" className="text-sm text-foreground cursor-pointer select-none">{t('events.fields.allDay', { defaultValue: 'Toute la journée' })}</label>
  </div>
  {isGoogleConnected && (
  <div className="flex items-center gap-2">
  <input
   ...
   className="rounded border-border/40 text-primary focus-visible:ring-primary w-5 h-5"
  />
  <label htmlFor="syncGoogle" className="text-sm text-foreground flex items-center cursor-pointer select-none">
 ...
 <div className="pt-6 border-t border-border/40 shrink-0 flex justify-end gap-3 mt-8">
  <Button
  type="button"
  variant="ghost"
  onClick={onClose}
