...
export const ThreatDashboard: React.FC<ThreatDashboardProps> = ({ threats }) => {
 ...
 <div className="space-y-2 relative z-10">
  ...
  <span className="text-sm font-bold text-muted-foreground uppercase tracking-wider">Actives (24h)</span>
  </div>
 </div>

 <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full md:w-auto relative z-10">
  {/* Critical Threats Card */}
  <div className="group/card relative rounded-2xl bg-white/40 dark:bg-white/5 border border-border/40 p-5 backdrop-blur-md shadow-sm transition-all hover:scale-[1.02] hover:shadow-md hover:bg-red-500 dark:hover:bg-red-900/20">
  ...
  {/* Ransomware Card */}
  <div className="group/card relative rounded-2xl bg-white/40 dark:bg-white/5 border border-border/40 p-5 backdrop-blur-md shadow-sm transition-all hover:scale-[1.02] hover:shadow-md hover:bg-primary/10 dark:hover:bg-primary">
  <div className="absolute inset-x-0 -top-px h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent opacity-0 group-hover/card:opacity-70 transition-opacity" />
  ...
  {/* Malware Card */}
  <div className="group/card relative rounded-2xl bg-white/40 dark:bg-white/5 border border-border/40 p-5 backdrop-blur-md shadow-sm transition-all hover:scale-[1.02] hover:shadow-md hover:bg-orange-50/50 dark:hover:bg-orange-900/20">
 ...
 <div className="glass-premium p-4 sm:p-6 rounded-3xl border border-border/40">
  <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-6">Top Types de Menaces</h3>
 ...
 {/* Activity Trend */}
 <div className="glass-premium p-4 sm:p-6 rounded-3xl border border-border/40">
  <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-6">Volume d'Activité (24h)</h3>
  <div className="h-[250px] w-full">
