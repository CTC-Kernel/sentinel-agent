...
export const ExportDORARegisterModal: React.FC<ExportDORARegisterModalProps> = ({
    ...
    }, [organization, selectedFormat, categoryFilter, providers, i18n.language, user, t, onClose, filteredProviders.length]);
                    ...
                    <div className="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <div className="text-center">
                                ...
                                <div className="text-xs text-slate-500">{t('dora.export.providers')}</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-red-600">
                                    {criticalCount}
                                </div>
                                <div className="text-xs text-slate-500">{t('dora.category.critical')}</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-amber-600">
                                    {highRiskCount}
                                </div>
                                <div className="text-xs text-slate-500">{t('dora.export.highRisk')}</div>
                            </div>
                        </div>
