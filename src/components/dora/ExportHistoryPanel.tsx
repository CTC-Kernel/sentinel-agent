...
export const ExportHistoryPanel: React.FC<ExportHistoryPanelProps> = ({
 ...
 const locale = i18nLocale === 'en' ? enUS : fr;
 ...
 <div className="text-center py-12">
  <FileDown className="w-12 h-12 text-muted-foreground mx-auto mb-3" />
 ...
 <div className="space-y-3">
  ...
  className="bg-card border border-border/40 rounded-3xl p-4"
  >
