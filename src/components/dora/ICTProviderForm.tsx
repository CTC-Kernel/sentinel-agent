                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                <div className="flex items-center gap-2 mb-2">
                                                                    ...
                                                                    <span className={`font-bold ${isSelected ? `text-${config.color}-700 dark:text-${config.color}-400` : 'text-slate-700 dark:text-slate-300'}`}>
            ...
            {!readOnly && (
                <div className="flex justify-end gap-3 px-6 py-4 border-t border-slate-200/60 dark:border-white/5 bg-slate-50/50 dark:bg-black/20">
                    ...
                    <Button
                        type="submit"
                        isLoading={isLoading}
                        className="bg-gradient-to-r from-brand-600 to-indigo-600 hover:from-brand-700 hover:to-indigo-700 text-white"
                    >
