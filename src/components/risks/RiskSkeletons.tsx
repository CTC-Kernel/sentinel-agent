...
export const RiskMatrixSkeleton: React.FC = () => {
 ...
 <div className="glass-premium p-4 sm:p-6 rounded-4xl h-[600px] relative">
...
export const RiskContextSkeleton: React.FC = () => {
 return (
 <div className="glass-premium p-8 rounded-3xl border border-border/40 shadow-apple-sm space-y-8 animate-fade-in">
