...
const renderActiveShape = (props: SentinelPieActiveShapeProps) => {
    ...
    return (
        <g>
            <text x={cx} y={cyValue - 8} textAnchor="middle" className="fill-foreground font-black text-lg">
                {payload.name}
            </text>
            <text x={cx} y={cyValue + 14} textAnchor="middle" className="fill-muted-foreground text-sm font-mono">
