...
export const RiskStats: React.FC<RiskStatsProps> = ({ stats }) => {
 ...
 <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 relative z-10">
  ...
  <div className="h-px w-full md:w-px md:h-20 bg-gradient-to-b from-transparent via-border dark:via-white/5 to-transparent" />
  ...
  <span className="text-xs font-medium text-muted-foreground">Critiques</span>
  </div>
  </div>
  <div>
