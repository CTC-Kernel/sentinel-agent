...
export const RiskLinkedControls: React.FC<RiskLinkedControlsProps> = ({
 ...
 <div className="text-center py-8">
  ...
  <p className="text-sm text-muted-foreground">Aucun contrôle de sécurité lié</p>
 ...
 {/* Mitigation Coverage */}
 <div className="sm:col-span-2 p-4 bg-card rounded-3xl border border-border/40">
 ...
 <div className="space-y-2">
  ...
  <div
  key={ctrl.id || 'unknown'}
  className="flex items-center justify-between p-3 bg-card rounded-3xl border border-border/40 shadow-sm group hover:shadow-md transition-all"
  >
