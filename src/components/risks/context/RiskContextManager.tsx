...
const BusinessContextTab: React.FC<BusinessContextTabProps> = ({ data, onSave, isSaving }) => {
 ...
 <div>
 <h3 className="text-lg font-semibold text-foreground">Contexte Business</h3>
 ...
 {/* Activities */}
 <div>
 <label htmlFor="new-activity" className="block text-sm font-medium text-foreground mb-2">
 ...
 {/* Objectives */}
 <div>
 <label htmlFor="new-objective" className="block text-sm font-medium text-foreground mb-2">
 ...
 {/* Critical Processes */}
 <div>
 <label htmlFor="new-process" className="block text-sm font-medium text-foreground mb-2">
 Processus critiques
 </label>
 <div className="flex gap-2 mb-3">
 <input
...
const RegulatoryContextTab: React.FC<RegulatoryContextTabProps> = ({
 ...
 <div>
 <h3 className="text-lg font-semibold text-foreground">Contexte Réglementaire</h3>
 <p className="text-sm text-muted-foreground">Réglementations et normes applicables à votre organisation</p>
 </div>
 </div>
 ...
 {/* Description */}
 <div>
 <label htmlFor="reg-description" className="block text-sm font-medium text-foreground mb-2">
 ...
 className="p-4 rounded-3xl bg-muted/50 border border-border/40"
 >
 <h4 className="font-medium text-foreground mb-4">Nouvelle réglementation</h4>
 <div className="grid grid-cols-2 gap-4 mb-4">
 <div>
 <label htmlFor="reg-name" className="block text-sm text-muted-foreground mb-1">Nom *</label>
 <input
  id="reg-name"
  type="text"
 ...
 <div>
 <label htmlFor="reg-framework" className="block text-sm text-muted-foreground mb-1">Framework</label>
 <select
  id="reg-framework"
 ...
 <div>
 <label htmlFor="reg-obligations" className="block text-sm text-muted-foreground mb-1">Obligations clés</label>
 <input
  id="reg-obligations"
  type="text"
 ...
 <div>
 <label htmlFor="reg-deadline" className="block text-sm text-muted-foreground mb-1">Échéance de conformité</label>
 <input
  id="reg-deadline"
  type="date"
 ...
 <div
 key={reg.id || 'unknown'}
 className="flex items-center gap-4 p-4 rounded-3xl bg-card/50 border border-border/40"
 >
...
const RiskAppetiteTab: React.FC<RiskAppetiteTabProps> = ({ data, onSave, isSaving }) => {
 ...
 <div>
 <h3 className="text-lg font-semibold text-foreground">Appétit au Risque</h3>
 ...
 {/* Description */}
 <div>
 <label htmlFor="appetite-description" className="block text-sm font-medium text-foreground mb-2">
 ...
 <div>
 <h4 className="font-medium text-foreground mb-4">Seuils de risque acceptables</h4>
 ...
 <div>
 <h4 className="font-medium text-foreground mb-4">Seuils d'escalade</h4>
 ...
 <label htmlFor="escalation-automatic" className="font-medium text-foreground cursor-pointer">Escalade automatique</label>
 </div>
 <input
 ...
 <label htmlFor="escalation-management" className="font-medium text-foreground cursor-pointer">Direction</label>
 </div>
 <input
 ...
 <ChevronRight className="-ml-3 w-4 h-4 text-red-500" />
 <label htmlFor="escalation-board" className="font-medium text-foreground cursor-pointer">Conseil</label>
 </div>
 <input
 id="escalation-board"
 type="number"
...
const EvaluationCriteriaTab: React.FC<EvaluationCriteriaTabProps> = ({ data, onSave, isSaving }) => {
 ...
 <div>
 <h3 className="text-lg font-semibold text-foreground">Critères d'Évaluation</h3>
