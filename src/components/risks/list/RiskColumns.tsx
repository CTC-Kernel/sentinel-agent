    ...
    switch (strategy) {
        case 'Accepter':
            return {
                ...
                badge: 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-border/40 dark:border-slate-700'
            };
        case 'Atténuer':
            return {
                icon: ShieldCheck,
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex items-center">
                        <div className="w-10 h-10 rounded-3xl bg-slate-100 dark:bg-slate-800 border border-border/40 dark:border-border/40 flex items-center justify-center mr-4 text-slate-600 dark:text-slate-300 overflow-hidden shrink-0">
                            {ownerUser ? (
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="text-sm text-slate-700 dark:text-slate-300">{getOwnerName(row.original.owner)}</div>
                        </div>
                    </div>
                );
            },
