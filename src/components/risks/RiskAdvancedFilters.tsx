...
export const RiskAdvancedFilters: React.FC<RiskAdvancedFiltersProps> = ({
 ...
 return (
 <div className="bg-white/40/40 backdrop-blur-md rounded-3xl border border-white/20 dark:border-white/5 p-6 shadow-2xl relative z-40">
 <div className="flex items-center justify-between mb-6">
 <div>
  <h3 className="text-lg font-bold text-foreground">
  Filtres avancés
  </h3>
  <p className="text-xs text-muted-foreground mt-0.5">Personnalisez votre vue du registre</p>
 </div>
 <Button
  variant="ghost"
  size="icon"
