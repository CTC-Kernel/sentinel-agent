...
const LinkedRiskItem = React.memo(({ risk, onClick }: { risk: Risk, onClick: () => void }) => {
    ...
    return (
        <div
            ...
            role="button"
            tabIndex={0}
            className="cursor-pointer glass-premium p-4 rounded-3xl border border-border/40 flex justify-between items-center group hover:bg-white/50 dark:hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
        >
            <div>
...
const LinkedAssetItem = React.memo(({ asset, onClick }: { asset: Asset, onClick: () => void }) => {
    ...
    return (
        <div
            ...
            role="button"
            tabIndex={0}
            className="cursor-pointer glass-premium p-4 rounded-3xl border border-border/40 flex items-center gap-4 group hover:bg-white/50 dark:hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
        >
...
const LinkedAuditItem = React.memo(({ audit, onClick }: { audit: Audit, onClick: () => void }) => {
    ...
    return (
        <div
            ...
            role="button"
            tabIndex={0}
            className="cursor-pointer glass-premium p-4 rounded-3xl border border-border/40 bg-white/40 dark:bg-white/5 hover:bg-white/60 dark:hover:bg-white/10 transition-colors group focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
        >
