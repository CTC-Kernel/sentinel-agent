...
export const ProjectOverview: React.FC<ProjectOverviewProps> = ({ project }) => {
 ...
 <div className="p-6 bg-white/40 dark:bg-white/5 rounded-4xl border border-border/40 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
  ...
  <div className="text-4xl font-black text-foreground mb-2">{project.relatedAssetIds?.length || 0}</div>
  </div>
 </div>
 <div className="p-6 bg-white/40 dark:bg-white/5 rounded-4xl border border-border/40 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
  ...
  <div className="text-4xl font-black text-foreground mb-2">{project.relatedRiskIds?.length || 0}</div>
  </div>
 </div>
 <div className="p-6 bg-white/40 dark:bg-white/5 rounded-4xl border border-border/40 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
  ...
  <div className="text-4xl font-black text-foreground mb-2">{project.relatedControlIds?.length || 0}</div>
  </div>
 </div>
 </div>
 </div>
