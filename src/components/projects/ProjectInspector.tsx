...
export const ProjectInspector: React.FC<ProjectInspectorProps> = ({
 ...
 <>
  ...
  <Button variant="ghost" size="icon" onClick={handleDeleteClick} className="text-muted-foreground hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 dark:hover:bg-red-900/20" aria-label="Supprimer le projet">
