...
export const ProjectList: React.FC<ProjectListProps> = ({
    ...
    return (
        <motion.div variants={slideUpVariants} className="glass-panel w-full max-w-full rounded-3xl overflow-hidden shadow-sm border border-slate-200 dark:border-white/5 relative">
