...
export const PortfolioDashboard: React.FC<PortfolioDashboardProps> = ({ projects, loading }) => {
 ...
 <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
  ...
  <div className="lg:col-span-2 glass-premium p-6 md:p-8 rounded-4xl shadow-sm flex flex-col md:flex-row gap-6 border border-transparent animate-pulse">
  ...
  <div className="flex-1 grid grid-cols-3 gap-4 border-l border-border/40 px-6 mx-2">
  {[1, 2, 3].map(i => (
 ...
 return (
 <div className="flex flex-col items-center justify-center p-12 bg-muted/50 rounded-3xl border border-dashed border-border/40 min-h-[400px]">
 <EmptyChartState
 ...
 <div className="lg:col-span-2 glass-premium p-6 md:p-8 rounded-4xl shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-6 relative group border border-transparent overflow-hidden">
  ...
  <div>
  <h3 className="text-lg font-bold text-foreground mb-1">Santé du Portefeuille</h3>
  <p className="text-sm text-muted-foreground max-w-[250px]">Moyenne d'avancement globale.</p>
  </div>
  </div>
  {/* Key Metrics */}
  <div className="flex-1 grid grid-cols-3 gap-4 border-l border-r border-border/40 px-6 mx-2">
  <div>
 ...
 <div className="glass-premium p-4 sm:p-6 rounded-4xl border border-border/40 relative overflow-hidden">
  <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-4">Statut des Projets</h3>
 ...
 <div className="glass-premium p-4 sm:p-6 rounded-4xl border border-border/40">
  <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-4">Distribution de l'Avancement</h3>
 ...
 <div className="glass-premium p-4 sm:p-6 rounded-4xl border border-border/40">
  <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-4">Échéances à Venir (6 mois)</h3>
  <div className="h-[250px] w-full">
