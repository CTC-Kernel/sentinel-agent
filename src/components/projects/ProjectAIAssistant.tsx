...
export const ProjectAIAssistant: React.FC<ProjectAIAssistantProps> = ({ project, risks }) => {
 ...
 <div className="animate-fade-in relative z-10 flex-1 flex flex-col min-h-0">
  ...
  <button onClick={() => setResponse(null)} className="w-full py-3 bg-muted text-muted-foreground rounded-3xl text-sm font-bold hover:bg-muted dark:hover:bg-slate-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
  Retour aux options
  </button>
 </div>
 )}
