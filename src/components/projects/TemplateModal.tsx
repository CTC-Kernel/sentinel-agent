...
export const TemplateModal: React.FC<TemplateModalProps> = ({ isOpen, onClose, onSelectTemplate, managers }) => {
 ...
 <div className="overflow-y-auto max-h-[calc(90vh-200px)] relative z-decorator">
  ...
  <input
   ...
   className="w-full px-4 py-2 bg-muted border border-border/40 rounded-3xl focus-visible:ring-2 focus-visible:ring-primary focus-visible:border-transparent"
  />
