...
const SummaryCard: React.FC<SummaryCardProps> = ({ summary }) => {
 ...
 <div className="text-center">
  ...
  <span className="text-xs text-muted-foreground uppercase tracking-wider">Conformes</span>
 </div>
 <div className="text-center">
  ...
  <span className="text-xs text-muted-foreground uppercase tracking-wider">Non conformes</span>
 </div>
 <div className="text-center">
  ...
  <span className="text-xs text-muted-foreground uppercase tracking-wider">Agents</span>
 </div>
 </div>
 </div>
 );
