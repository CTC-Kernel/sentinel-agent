...
export const ComplianceScoreCard: React.FC<ComplianceScoreCardProps> = ({
 ...
 <button
  ...
  className="glass-premium p-4 rounded-2xl border border-border/40 hover:bg-white/40 dark:hover:bg-muted dark:hover:bg-muted cursor-pointer transition-all duration-300 group/item w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
 >
