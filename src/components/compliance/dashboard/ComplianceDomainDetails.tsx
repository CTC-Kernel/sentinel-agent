        ...
        <div className="glass-premium p-6 md:p-8 rounded-4xl relative group hover:shadow-apple transition-all duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 relative z-10">
                {Object.entries(domainData).map(([domain, data]) => {
                    ...
                    return (
                        <div key={domain || 'unknown'} className="p-4 bg-white/40 dark:bg-white/5 rounded-3xl border border-border/40 dark:border-border/40 backdrop-blur-sm hover:scale-[1.02] transition-transform duration-200">
