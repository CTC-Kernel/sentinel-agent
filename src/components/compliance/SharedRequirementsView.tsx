...
export const SharedRequirementsView: React.FC<SharedRequirementsViewProps> = ({
 ...
 <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
  ...
  <div className="p-4 bg-primary/10 dark:bg-primary rounded-3xl border border-primary/20 dark:border-primary/90">
  <div className="flex items-center gap-2 mb-1">
  <Layers className="w-4 h-4 text-primary" />
  <span className="text-xs font-medium text-primary dark:text-primary/50">
  Contrôles partagés
  </span>
  </div>
  <p className="text-2xl font-bold text-primary dark:text-primary/40">
 ...
 {/* Summary Footer */}
 <div className="glass-premium p-4 rounded-3xl bg-gradient-to-r from-green-50 to-primary/10 dark:from-green-900/20 dark:to-primary/20 border border-green-100 dark:border-green-900/30">
 <div className="flex items-center gap-3">
