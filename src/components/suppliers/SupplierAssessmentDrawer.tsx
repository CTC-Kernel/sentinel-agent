...
export const SupplierAssessmentDrawer: React.FC<Props> = ({
 ...
 className="w-full px-4 py-3 rounded-3xl border border-border/40 bg-muted/50 text-foreground focus-visible:ring-2 focus-visible:ring-primary focus-visible:border-primary"
 />
 </div>
 )}
