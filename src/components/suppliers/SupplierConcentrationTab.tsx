        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-3xl text-sm font-medium bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all disabled:bg-muted disabled:text-muted-foreground"
                >
            ...
            {activeSubTab === 'overview' && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {trends && trends.overallTrend.length > 0 && (
                        <div className="glass-premium p-4 sm:p-6 rounded-2xl lg:col-span-2 border border-border/40">
                            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">
