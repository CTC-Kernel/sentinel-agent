                ...
                <div className="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-600 bg-transparent focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-shadow outline-none dark:text-white"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-600 bg-transparent focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-shadow outline-none min-h-[80px] dark:text-white"
