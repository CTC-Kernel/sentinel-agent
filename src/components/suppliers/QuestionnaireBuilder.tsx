...
export const QuestionnaireBuilder: React.FC<Props> = ({ initialData, onSave, onCancel }) => {
 ...
 <div className="grid grid-cols-1 gap-4">
  ...
  <div>
  <label htmlFor="questionnaire-desc" className="block text-sm font-medium text-foreground mb-1">Description</label>
  <textarea
 ...
 <Button
  ...
  className="flex items-center text-sm font-medium text-primary bg-primary/10 dark:bg-primary hover:bg-primary/15"
 >
