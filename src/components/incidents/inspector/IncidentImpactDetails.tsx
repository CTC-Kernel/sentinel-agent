...
export const IncidentImpactDetails: React.FC<IncidentImpactDetailsProps> = ({
 ...
 <div className="relative z-10">
  ...
  {t('incidents.inspector.affectedAsset', { defaultValue: 'Actif Impacté' })}
  </h3>
  ...
  ) : <p className="text-sm text-muted-foreground italic">{t('incidents.inspector.assetNotFound', { defaultValue: 'Actif introuvable' })}</p>;
  })()}
  </div>
  ) : (
  <p className="text-sm text-muted-foreground italic">{t('incidents.inspector.noAssetLinked', { defaultValue: 'Aucun actif lié' })}</p>
  )}
 </div>
 </div>
 ...
 <div className="relative z-10">
  ...
  {t('incidents.inspector.affectedService', { defaultValue: 'Service Impacté' })}
  </h3>
  ...
  ) : <p className="text-sm text-muted-foreground italic">{t('incidents.inspector.processNotFound', { defaultValue: 'Processus introuvable' })}</p>;
  })()}
  </div>
  ) : (
  <p className="text-sm text-muted-foreground italic">{t('incidents.inspector.noServiceLinked', { defaultValue: 'Aucun service lié' })}</p>
  )}
 </div>
 </div>
 ...
 <div className="relative z-10">
  ...
  {t('incidents.inspector.relatedRisk', { defaultValue: 'Risque Lié' })}
  </h3>
  ...
  ) : <p className="text-sm text-muted-foreground italic">{t('incidents.inspector.riskNotFound', { defaultValue: 'Risque introuvable' })}</p>;
  })()}
  </div>
  ) : (
  <p className="text-sm text-muted-foreground italic">{t('incidents.inspector.noRiskLinked', { defaultValue: 'Aucun risque lié' })}</p>
  )}
 </div>
 </div>
 </div>
