...
export const IncidentGeneralDetails: React.FC<IncidentGeneralDetailsProps> = ({ incident, onStatusChange, isUpdating }) => {
 ...
 <div className="bg-[var(--glass-bg)] backdrop-blur-xl p-4 sm:p-6 rounded-xl border border-border/40 shadow-premium relative overflow-hidden glass-premium">
  ...
  {t('incidents.inspector.noDescription', { defaultValue: 'Aucune description.' })}
  </p>
  )}
  </div>
 </div>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
  ...
  <div className="flex gap-2 mt-2">
   ...
   disabled={isUpdating}
   className="px-3 py-1.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-2xl text-xs font-bold transition-all disabled:opacity-50"
   >
 ...
 <div className="bg-[var(--glass-bg)] backdrop-blur-xl p-4 sm:p-6 rounded-xl border border-border/40 shadow-premium space-y-4 relative overflow-hidden glass-premium">
  ...
  <div className="mt-4">
  <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider">{t('incidents.inspector.reportedBy', { defaultValue: 'Déclaré par' })}</div>
