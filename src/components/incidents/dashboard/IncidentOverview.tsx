...
export const IncidentOverview: React.FC<IncidentOverviewProps> = ({ incidents, agents = [], loading = false }) => {
 ...
 return (
 <g>
 <text x={cx} y={cy - 8} textAnchor="middle" fill="currentColor" className="text-foreground text-lg font-black">
  {payload.value}
 </text>
 <text x={cx} y={cy + 12} textAnchor="middle" className="text-[11px] fill-muted-foreground font-bold uppercase">
  {payload.name}
 </text>
 <Sector
  cx={cx}
 ...
 <div className="flex items-center gap-8 relative z-10">
  ...
  >
  <defs>
   <linearGradient id={svgIds.gaugeGradient} x1="0" y1="0" x2="1" y2="1">
