...
const RiskMatrixCell: React.FC<{
 ...
 if (vendors.length === 0) {
 return (
 <div className="h-24 rounded-lg border-2 border-dashed border-border/40 flex items-center justify-center">
...
const StatisticsCards: React.FC<{ statistics: ScoringStatistics }> = ({
 ...
 <div className="bg-card rounded-3xl p-4 border border-border/40">
...
export const VendorComparison: React.FC<VendorComparisonProps> = ({
 ...
 className="appearance-none pl-8 pr-8 py-2 rounded-lg border border-border/40 bg-card text-sm"
 >
