    ...
    return (
        <div className="p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-white/60 dark:hover:bg-white/10 transition-colors backdrop-blur-[2px]">
                ...
                <div className="min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {user.uid === currentUser?.uid && (
                            <span className="px-2 py-0.5 text-[11px] font-medium bg-slate-100/50 text-slate-600 dark:text-slate-300 dark:bg-slate-700/50 dark:text-slate-300 rounded-full border border-border/40 dark:border-slate-600/50">
                                {t('settings.you')}
                            </span>
                        )}
                    </div>
            ...
            <div className="flex items-center gap-3 self-end sm:self-auto">
                ...
                <div className="flex items-center border-l border-white/20 dark:border-border/40 pl-3 gap-1">
