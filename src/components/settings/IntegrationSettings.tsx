...
export const IntegrationSettings: React.FC = () => {
 ...
 <h2 className="text-2xl font-bold text-foreground mb-6 col-span-1 md:col-span-2">{t('settings.integrations')}</h2>
 ...
 <div className="relative z-10 p-6 flex-1 flex flex-col justify-between space-y-6">
  ...
  className="w-full mt-2 rounded-3xl shadow-lg shadow-primary/20"
  >
 ...
 <div className="relative z-10 p-6 flex-1 flex flex-col justify-center space-y-6">
  ...
  <h4 className="text-sm font-bold text-foreground mb-2">{t('settings.integrationsPage.exportIcal')}</h4>
