...
export const OrganizationSettings: React.FC = () => {
 ...
 <h2 className="text-2xl font-bold text-foreground mb-6">{t('settings.organization')}</h2>
 ...
 <PremiumCard glass className="p-0 rounded-3xl border border-border/40 shadow-sm relative overflow-hidden">
  ...
  <h3 className="text-lg font-bold text-foreground">{t('settings.admin')}</h3>
  </div>
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
   ...
   <label htmlFor="country-select" className="block text-sm font-medium text-foreground text-muted-foreground">
  ...
  <div className="pt-6 border-t border-border/40">
  <h4 className="text-md font-semibold text-foreground mb-4 flex items-center gap-2">
   <span className="text-primary">✨</span> {t('settings.aiPrivacyTitle', { defaultValue: 'Sentinel AI & Confidentialité' })}
  </h4>
  ...
  <Button type="submit" isLoading={savingOrg} disabled={savingOrg} className="min-w-[140px] shadow-lg shadow-primary/20">
 ...
 <PremiumCard glass className="p-0 rounded-3xl border border-border/40 shadow-sm relative overflow-hidden">
  ...
  <div>
  <h3 className="text-lg font-bold text-foreground">{t('settings.users')}</h3>
