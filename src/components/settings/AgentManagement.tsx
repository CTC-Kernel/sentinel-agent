...
export const AgentManagement: React.FC = () => {
 ...
 return (
 <g>
 <text x={cx} y={cy} dy={-5} textAnchor="middle" className="fill-foreground dark:fill-white text-sm font-bold">
  {payload.name}
 </text>
 <text x={cx} y={cy} dy={15} textAnchor="middle" className="fill-muted-foreground text-xs">
  {value} agents
 </text>
 <Sector
  cx={cx}
 ...
 <div className="xl:col-span-2 space-y-4">
  ...
  <thead>
   <tr className="border-b border-border/40">
   <th className="px-6 py-3 text-xs font-bold text-muted-foreground uppercase tracking-widest">{t('settings.agents.token', { defaultValue: 'Token' })}</th>
   <th className="px-6 py-3 text-xs font-bold text-muted-foreground uppercase tracking-widest">{t('settings.agents.tokenStatus', { defaultValue: 'Statut' })}</th>
   <th className="px-6 py-3 text-xs font-bold text-muted-foreground uppercase tracking-widest">{t('settings.agents.uses', { defaultValue: 'Utilisations' })}</th>
   <th className="px-6 py-3 text-xs font-bold text-muted-foreground uppercase tracking-widest">{t('settings.agents.expiration', { defaultValue: 'Expiration' })}</th>
  ...
  <tbody className="divide-y divide-border dark:divide-white/5">
   ...
   <td className="px-6 py-4 text-right">
    ...
    {t('settings.agents.revoke', { defaultValue: 'Révoquer' })}
    </Button>
    )}
   </td>
   </tr>
 ...
 <div className="space-y-6">
  ...
  >
   <div className="flex items-center justify-between">
   <div>
   <h3 className="text-lg font-bold text-foreground">{t('settings.agents.downloads', { defaultValue: 'Téléchargements' })}</h3>
   {releaseInfo?.currentVersion && (
   <div className="flex items-center gap-2 mt-0.5">
    <Badge variant="outline" className="text-[11px] bg-primary/10 border-primary/40 text-primary">
