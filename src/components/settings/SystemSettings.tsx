 ...
 */
 ...
 cell: ({ getValue }) => (
 <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-muted text-foreground border border-border/40">
  {getValue() as string}
 </span>
 )
 },
 ...
 return (
  <span className="text-muted-foreground text-xs truncate max-w-[200px] block" title={str}>
  {str}
  </span>
 );
 }
 ...
 <h2 className="text-2xl font-bold text-foreground mb-6 animate-slide-in-left">{t('settings.system')}</h2>
