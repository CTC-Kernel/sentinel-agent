...
export const BackupStats: React.FC<BackupStatsProps> = ({ stats }) => {
 ...
 <div className="flex items-center relative z-decorator">
  ...
  <div>
  <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1">Total Backups</p>
  <p className="text-3xl font-black text-foreground">{stats.totalBackups}</p>
  </div>
 </div>
 </PremiumCard>
 ...
 <div className="flex items-center relative z-decorator">
  ...
  <div>
  <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1">Espace Utilisé</p>
  <p className="text-3xl font-black text-foreground">{formatSize(stats.totalSize)}</p>
  </div>
 </div>
 </PremiumCard>
 ...
 <div className="flex items-center relative z-decorator">
  ...
  <div>
  <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1">Dernier Backup</p>
