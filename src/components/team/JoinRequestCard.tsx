                ...
                <div className="mt-auto flex gap-2 pt-3">
                    <CustomTooltip content={t('team.actions.reject')}>
                        <button
                            ...
                            className="flex-1 py-2 bg-white/50 dark:bg-slate-800/50 border border-border/40 dark:border-border/40 text-slate-600 dark:text-slate-300 rounded-3xl text-xs font-bold hover:bg-red-50 dark:hover:bg-red-900/30 hover:text-red-600 hover:border-red-200 dark:hover:bg-red-900/20 dark:hover:text-red-400 transition-all flex items-center justify-center gap-1"
                        >
