...
export const GroupManager: React.FC<GroupManagerProps> = ({ users }) => {
 ...
 <div>
  <h3 className="text-lg font-bold text-foreground">{t('team.groups.title', { defaultValue: 'Groupes Utilisateurs' })}</h3>
  <p className="text-sm text-muted-foreground">{t('team.groups.subtitle', { defaultValue: 'Créez des équipes pour organiser vos collaborateurs.' })}</p>
 </div>
 <Button
 ...
 <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
  ...
  <h4 className="font-bold text-foreground mb-4">{t('team.groups.members', { defaultValue: 'Membres du groupe' })}</h4>
  <MemberSelector
  users={users}
