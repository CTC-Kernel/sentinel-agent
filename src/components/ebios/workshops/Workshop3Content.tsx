...
export const Workshop3Content: React.FC<Workshop3ContentProps> = ({
 ...
 <div className="absolute top-6 left-6 z-decorator glass-premium backdrop-blur-md px-6 py-3 rounded-2xl border border-border/40">
 <h3 className="text-xl font-bold text-foreground flex items-center gap-3">
 <div className="p-2 rounded-3xl bg-primary text-primary-foreground shadow-lg shadow-primary">
 ...
 >
  ...
  <span>{t('ebios.visualize', { defaultValue: 'Visualiser' })}</span>
 </button>
 </div>
 )}
 </div>
 ...
 {data.ecosystem.map((party) => {
  ...
  "bg-card/40 backdrop-blur-sm hover:shadow-lg hover:-translate-y-1",
  ...
  : "bg-muted text-muted-foreground group-hover:bg-primary/15 dark:group-hover:bg-primary group-hover:text-primary dark:group-hover:text-primary/70 transition-colors"
  )}>
  ...
  <span className="text-xs font-medium text-muted-foreground">{t('ebios.workshop3.trustLevel')}</span>
 ...
 <div className="text-center py-12 bg-muted/30 rounded-3xl border border-dashed border-border/40">
  ...
  <p className="text-muted-foreground">{t('ebios.workshop3.addEcosystemFirst')}</p>
 </div>
 ) : (
 <div className="space-y-4">
  ...
  <div
  key={path.id || 'unknown'}
  className="group relative p-5 rounded-2xl border border-border/40 bg-card/40 backdrop-blur-sm hover:shadow-lg hover:border-orange-300 dark:hover:border-orange-700 transition-all duration-300"
  >
  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
  <div className="flex-1 min-w-0">
  <h4 className="font-bold text-foreground mb-2 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
  {path.name}
  </h4>

  <div className="flex flex-wrap items-center gap-3 text-sm">
  <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-primary/15 dark:bg-primary text-primary dark:text-primary/50 border border-primary/30 dark:border-primary/80">
  ...
  <div className="flex items-center gap-6 pt-4 md:pt-0 border-t md:border-t-0 border-border/40">
 ...
 <div className="text-center py-12 bg-muted/30 rounded-3xl border border-dashed border-border/40">
  ...
  <p className="text-muted-foreground">{t('ebios.workshop3.retainPairsFirst')}</p>
 </div>
 ) : (
 <div className="space-y-4">
  ...
  className="group relative p-5 rounded-2xl border border-border/40 bg-card/40 backdrop-blur-sm hover:shadow-lg hover:border-error/30 transition-all duration-300"
  >
  <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
  <div className="flex-1 min-w-0">
  <h4 className="font-bold text-foreground text-lg mb-2 group-hover:text-error-text transition-colors">
  {scenario.name}
  </h4>
