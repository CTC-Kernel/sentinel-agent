...
export const SecurityBaselinePanel: React.FC<SecurityBaselinePanelProps> = ({
 ...
 <div className="text-center p-4 rounded-3xl bg-card/50 border border-border/40/50">
 <ProgressRing
 ...
 className="mx-auto"
 />
 <p className="text-sm text-muted-foreground mt-2">{t('ebios.workshop1.maturityScore')}</p>
 </div>
 ...
 className="px-4 py-2.5 rounded-3xl border border-border/40 bg-card text-foreground"
 >
