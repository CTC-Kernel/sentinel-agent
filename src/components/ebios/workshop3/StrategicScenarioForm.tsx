...
export const StrategicScenarioForm: React.FC<StrategicScenarioFormProps> = ({
 ...
 className={cn(
 "w-full px-4 py-2.5 rounded-3xl border bg-card",
 errors.name
  ? "border-red-500"
  : "border-border/40"
 )}
 ...
 {/* SR/OV Pair */}
 <div>
 <label htmlFor="srOvPairId" className="block text-sm font-medium text-foreground mb-1">
 ...
 className="w-full px-4 py-2.5 rounded-3xl border border-border/40 bg-card resize-none"
 />
 </div>
 ...
 {watchedGravity >= 3 && (
 <div>
 <label htmlFor="gravityJustification" className="block text-sm font-medium text-foreground mb-1">
 ...
 <textarea
  ...
  className={cn(
  "w-full px-4 py-2.5 rounded-3xl border bg-card resize-none",
