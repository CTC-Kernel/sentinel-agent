...
export const AttackPathForm: React.FC<AttackPathFormProps> = ({
 ...
 <p className="text-sm text-muted-foreground mb-2">{t('ebios.workshop3.pathPreview', 'Aperçu du chemin')}:</p>
 ...
 <label className="block text-sm font-medium text-foreground text-muted-foreground">
