...
export const OperationalScenarioForm: React.FC<OperationalScenarioFormProps> = ({
 ...
 <label htmlFor="strategicScenarioId" className="block text-sm font-medium text-foreground text-muted-foreground">
 ...
 className={cn(
 "w-full px-4 py-3 rounded-3xl border bg-card text-foreground",
 ...
 {/* Name */}
 <div className="space-y-2">
 <label htmlFor="name" className="block text-sm font-medium text-foreground text-muted-foreground">
 ...
 {/* Description */}
 <div className="space-y-2">
 <label htmlFor="description" className="block text-sm font-medium text-foreground text-muted-foreground">
 ...
 className={cn(
 "w-full px-4 py-3 rounded-3xl border bg-card text-foreground resize-none",
 errors.description
  ? 'border-red-300 dark:border-red-700'
  : 'border-border/40'
 )}
 ...
 {/* Actions */}
 <div className="flex justify-end gap-3 pt-4 border-t border-border/40/50">
 <button
 type="button"
 onClick={onClose}
