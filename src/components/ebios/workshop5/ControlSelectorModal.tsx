...
export const ControlSelectorModal: React.FC<ControlSelectorModalProps> = ({
 ...
 {/* Search & Filters */}
 <div className="py-4 space-y-3 border-b border-border/40/50">
 ...
 return (
 <div key={domain.id || 'unknown'} className="border border-border/40 rounded-3xl overflow-hidden">
 {/* Domain Header */}
 <button
 ...
 <p className="text-muted-foreground">{t('ebios.workshop5.noControlsFound')}</p>
 </div>
 )}
 </div>

 {/* Footer */}
 <div className="pt-4 border-t border-border/40/50 flex items-center justify-between">
