...
export const SectorRecommendations: React.FC<SectorRecommendationsProps> = ({
 ...
 <h4 className="text-sm font-medium text-foreground flex items-center gap-2">
  ...
  <span className="text-muted-foreground">({pendingSourceRecommendations.length})</span>
 </h4>
 ...
 {pendingSourceRecommendations.map((source) => (
  ...
  className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-card border border-border/40 text-sm"
  >
  <span className="font-medium text-red-600 dark:text-red-400">{source.code}</span>
  <span className="text-muted-foreground">-</span>
  <span className="text-foreground truncate max-w-[150px]">{source.name}</span>
  {!readOnly && (
 ...
 <h4 className="text-sm font-medium text-foreground flex items-center gap-2">
  ...
  <span className="text-muted-foreground">({pendingObjectiveRecommendations.length})</span>
 </h4>
 ...
 {pendingObjectiveRecommendations.map((obj) => (
  ...
  <span className="text-muted-foreground">-</span>
  <span className="text-foreground truncate max-w-[150px]">{obj.name}</span>
  {!readOnly && (
  <div className="flex items-center gap-1 ml-2">
  <button
