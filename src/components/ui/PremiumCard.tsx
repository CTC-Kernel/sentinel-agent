...
export const PremiumCard: React.FC<PremiumCardProps> = ({
    ...
    const baseClasses = "rounded-3xl p-6 transition-all duration-normal active:duration-75 ease-apple relative group border border-border/40 shadow-sm overflow-hidden isolation-isolate [mask-image:radial-gradient(white,black)]";
