...
export const CopyButton: React.FC<CopyButtonProps> = ({
 ...
 <AnimatePresence>
  ...
  transition={{ duration: 0.15 }}
  className={cn(
  'absolute z-tooltip px-2 py-1 text-xs font-medium bg-foreground text-white rounded-md whitespace-nowrap pointer-events-none',
...
export const CopyField: React.FC<CopyFieldProps> = ({
 ...
 <div className="flex items-center gap-2 p-2.5 bg-muted/50 border border-border/40 rounded-xl">
