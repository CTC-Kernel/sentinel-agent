    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    "h-7 w-7 bg-transparent hover:opacity-70 border border-slate-200 dark:border-white/10 p-0 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 dark:hover:bg-white/10 flex items-center justify-center opacity-60 transition-all"
                ),
                ...
                day: cn(
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-70 rounded-lg transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 dark:hover:bg-white/10"
                ),
                ...
                day_outside:
                    "day-outside text-slate-600 dark:text-slate-400 opacity-60 aria-selected:bg-slate-100/50 aria-selected:text-slate-600 aria-selected:opacity-30",
