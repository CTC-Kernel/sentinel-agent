...
function Calendar({
 ...
 nav_button: cn(
  "h-7 w-7 bg-transparent hover:opacity-70 border border-border/40 p-0 rounded-lg hover:bg-muted dark:hover:bg-white/10 flex items-center justify-center opacity-60 transition-all"
 ),
 ...
 day: cn(
  "h-9 w-9 p-0 font-normal aria-selected:opacity-70 rounded-lg transition-colors hover:bg-muted dark:hover:bg-white/10"
 ),
 day_range_end: "day-range-end",
 day_selected:
  "bg-primary text-primary-foreground hover:bg-primary/90 hover:text-white focus:bg-primary focus:text-white",
