...
export const LoadingIndicator: React.FC<LoadingIndicatorProps> = ({
 ...
 {type === 'spinner' && (
  ...
  <Spinner size="lg" className="text-primary relative z-decorator" />
  </>
 )}
 ...
 {type === 'pulse' && (
  ...
  className="w-2.5 h-2.5 bg-primary rounded-full shadow-[0_0_8px_rgba(var(--brand-500-rgb),0.5)]"
  />
  <motion.div
  animate={{ scale: [1, 1.2, 1], opacity: [0.5, 1, 0.5] }}
 ...
 {type === 'bar' && (
  ...
  className="absolute inset-y-0 w-1/2 bg-gradient-to-r from-transparent via-primary to-transparent shadow-[0_0_8px_rgba(var(--brand-500-rgb),0.5)]"
  />
  </div>
 )}
 </div>
