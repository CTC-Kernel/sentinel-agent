                ...
                {tabs.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={isLoading}
                            className={`relative px-4 py-2 text-sm font-medium rounded-full transition-colors flex items-center whitespace-nowrap z-decorator focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${isActive
                                ? 'text-foreground'
                        ...
                        >
                            ...
                            {tab.count !== undefined && !isLoading && (
                                <span className={`ml-2 px-2 py-0.5 rounded-full text-[10px] font-bold transition-all ${isActive
                                    ? 'bg-primary text-primary-foreground shadow-sm'
                                    : 'bg-muted-foreground/10 text-muted-foreground border border-border/10'
                                    }`}>
                                    {tab.count}
                                </span>
                            )}
