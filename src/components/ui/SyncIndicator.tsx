    ...
    if (!isOnline) {
        return (
            <Tooltip content={t('common.offlineMode') || "Mode Hors-ligne"} position="bottom">
                <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-300 rounded-full text-xs font-medium border border-border/40 dark:border-slate-700 animate-pulse">
