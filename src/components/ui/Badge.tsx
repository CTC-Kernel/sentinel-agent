...
export const Badge: React.FC<BadgeProps> = React.memo(({
 ...
 case 'brand':
 if (variant === 'outline') return "border border-primary text-primary dark:text-primary/70 dark:border-primary/60";
 if (variant === 'glass') return "bg-primary/20 backdrop-blur-md text-primary dark:text-white border border-primary/40 shadow-sm";
 if (variant === 'soft') return "bg-primary/10 text-primary dark:text-white border border-primary/20 dark:border-primary/60";
 return "bg-gradient-primary text-white shadow-sm shadow-primary/25";
