...
export const LegalModal: React.FC<LegalModalProps> = ({ isOpen, onClose, initialTab = 'mentions' }) => {
 ...
 <div className="relative w-full max-w-4xl bg-card border border-border/40/50 shadow-2xl shadow-black/20 dark:shadow-black/50 rounded-3xl overflow-hidden flex flex-col max-h-[85vh] animate-scale-in">
 {/* Header */}
 <div className="px-8 py-6 border-b border-border/40/50 flex items-center justify-between bg-muted/50">
  <div>
  <h2 className="text-2xl font-bold text-foreground tracking-tight">Informations Légales</h2>
  <p className="text-sm text-muted-foreground mt-1">Transparence et conformité</p>
  </div>
  <button
 ...
 {/* Tabs */}
 <div className="px-8 border-b border-border/40 dark:border-white/5 flex gap-8 overflow-x-auto no-scrollbar bg-card">
  {tabs.map(tab => (
  <button
  key={tab.id || 'unknown'}
  ...
  >
  <tab.icon className={`h-4 w-4 mr-2.5 ${activeTab === tab.id ? 'text-primary' : 'opacity-70'}`} />
  {tab.label}
  </button>
  ))}
 </div>
 ...
 <div className="flex-1 overflow-y-auto p-8 custom-scrollbar bg-card">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">Éditeur du Service</h3>
   <div className="bg-card/50 p-6 rounded-2xl border border-border/40 dark:border-white/5 shadow-sm">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">Hébergement</h3>
   <div className="bg-card/50 p-6 rounded-2xl border border-border/40 dark:border-white/5 shadow-sm space-y-4">
   <div>
   <p className="font-medium">Google Cloud Platform</p>
   <p className="text-sm text-muted-foreground mt-1">Google Ireland Limited</p>
   <p className="text-sm text-muted-foreground">Gordon House, Barrow Street, Dublin 4, Irlande</p>
   </div>
   <div>
   <p className="font-medium">OVHcloud</p>
   <p className="text-sm text-muted-foreground mt-1">OVH SAS</p>
   <p className="text-sm text-muted-foreground">2 rue Kellermann, 59100 Roubaix, France</p>
   </div>
   </div>
  </section>

  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">Directeur de la Publication</h3>
   <p className="text-muted-foreground">Monsieur le Gérant de Cyber Threat Consulting.</p>
  </section>
  </div>
  )}
  ...
  {activeTab === 'privacy' && (
  <div className="space-y-6 animate-fade-in">
  <div className="bg-info-50/20 p-4 rounded-3xl border border-info-100 dark:border-info-800 text-info-800 dark:text-info-200 text-sm font-medium mb-6">
   Conformément au RGPD, Sentinel GRC assure la protection de vos données personnelles.
  </div>

  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">1. Collecte des Données</h3>
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">2. Finalité du Traitement</h3>
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">3. Services Tiers</h3>
  ...
  <div className="space-y-6 animate-fade-in">
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">1. Acceptation</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">2. Accès au Service</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">3. Propriété Intellectuelle</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">4. Responsabilité</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">1. Objet</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">2. Abonnement et Services</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">3. Durée et Renouvellement</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">4. Tarifs et Paiement</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">5. Résiliation</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
  ...
  <section>
   <h3 className="text-lg font-bold text-foreground mb-3">6. Données Personnelles et Sécurité</h3>
   <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 {/* Footer */}
 <div className="p-6 border-t border-border/40/50 bg-muted/50 flex justify-end">
  <button
  aria-label="Fermer la fenêtre"
  onClick={onClose}
