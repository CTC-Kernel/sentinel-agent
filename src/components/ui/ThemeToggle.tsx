...
export function ThemeToggle() {
    ...
    return (
        <Button variant="ghost" size="icon" onClick={toggleTheme} className="rounded-full w-10 h-10 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-border/40 text-muted-foreground dark:text-white transition-colors relative overflow-hidden">
