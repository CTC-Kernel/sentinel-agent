...
export const AdvancedSearch: React.FC<AdvancedSearchProps> = ({ onSearch, onClose }) => {
 ...
 {/* Filters Toggle */}
 <div className="px-6 py-3 border-b border-border/40 bg-muted/50">
  <Button
  aria-label={showFilters ? 'Masquer les filtres' : 'Afficher les filtres'}
  onClick={() => setShowFilters(!showFilters)}
  variant="ghost"
  size="sm"
  className="flex items-center gap-2 text-foreground hover:text-primary dark:hover:text-primary/70"
  >
 ...
 {showFilters && (
  ...
  {/* Type Filter */}
  <div>
  <label htmlFor="search-type" className="block text-sm font-bold text-foreground mb-2">
  Type de ressource
  </label>
  <select
  id="search-type"
  ...
  {/* Status Filter */}
  <div>
  <label htmlFor="search-status" className="block text-sm font-bold text-foreground mb-2">
  Statut
  </label>
  <input
  id="search-status"
  ...
  {/* Owner Filter */}
  <div>
  <label htmlFor="search-owner" className="block text-sm font-bold text-foreground mb-2 flex items-center gap-2">
  ...
  <div>
  <label htmlFor="search-date-from" className="block text-sm font-bold text-foreground mb-2 flex items-center gap-2">
  ...
  <div>
  <label htmlFor="search-date-to" className="block text-sm font-bold text-foreground mb-2">
   Date de fin
  </label>
  <input
   id="search-date-to"
  ...
  {/* Criticality Filter */}
  <div>
  <label htmlFor="search-criticality" className="block text-sm font-bold text-foreground mb-2">
  Criticité
  </label>
  <select
 ...
 {/* Actions */}
 <div className="p-6 border-t border-border/40 bg-muted/50 flex items-center justify-between">
  <Button
  ...
  className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold shadow-lg hover:shadow-xl hover:scale-105"
  >
  Rechercher
  </Button>
  </div>
