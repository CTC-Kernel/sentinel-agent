...
export const AddToCalendar: React.FC<AddToCalendarProps> = ({ event, className }) => {
 ...
 {isOpen && (
 <div className="absolute right-0 mt-2 w-48 bg-card rounded-3xl shadow-xl border border-border/40 dark:border-white/5 z-tooltip overflow-hidden animate-in fade-in zoom-in-95 duration-200">
  <div className="p-1">
  <a
