...
export const OnboardingCard: React.FC<OnboardingCardProps> = ({
 ...
 <div className="relative p-6">
  ...
  <span className="inline-block px-2.5 py-1 rounded-full bg-muted/80 text-foreground dark:bg-white/10 dark:text-white text-[11px] font-bold uppercase tracking-widest border border-border/40 shadow-sm backdrop-blur-md">
  ...
  {/* Content */}
  <p className="text-foreground text-[15px] leading-relaxed mb-6 font-medium tracking-normal">
  {step.description}
  </p>
