                ...
                <div className="relative p-6">
                    ...
                    <div className="flex justify-between items-start mb-4">
                        <div className="space-y-1">
                            <span className="inline-block px-2.5 py-1 rounded-full bg-slate-100/80 text-slate-700 dark:text-slate-300 dark:bg-white/10 dark:text-white text-[11px] font-bold uppercase tracking-widest border border-border/40 dark:border-border/40 shadow-sm backdrop-blur-md">
