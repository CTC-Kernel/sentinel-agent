...
export const FilterPill: React.FC<FilterPillProps> = ({
 ...
 const colorStyles = {
 brand: 'bg-primary/10 text-primary border-primary/20 dark:bg-primary dark:text-primary/70 dark:border-primary/80',
 ...
 <button
 onClick={onRemove}
 className="ml-0.5 p-0.5 hover:bg-muted rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
