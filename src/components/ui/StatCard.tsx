...
export const StatCard: React.FC<StatCardProps> = React.memo(({
    ...
    return (
        <motion.div
            ...
            className={cn(
                'relative group p-6 rounded-3xl border transition-all duration-500 isolate',
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-white/30 dark:from-white/5 to-transparent pointer-events-none opacity-60 group-hover:opacity-70 transition-opacity duration-500 rounded-[inherit]" />
