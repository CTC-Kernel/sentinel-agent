...
const AgentDownloads: React.FC = () => {
  ...
  const downloads: AgentDownload[] = [
    ...
    },
    {
      ...
      version: '2.0.0',
      size: '8.5MB',
      url: '/downloads/agents/windows/SentinelAgentSetup-2.0.0.msi',
      status: 'available',
    ...
    },
    {
      ...
      version: '2.0.0',
      size: '9.3MB',
      url: '/downloads/agents/linux_deb/sentinel-agent_2.0.0_arm64.deb',
      status: 'available',
    ...
    },
    {
      ...
      version: '2.0.0',
      size: '9.3MB',
      url: '/downloads/agents/linux_rpm/sentinel-agent-2.0.0.x86_64.rpm',
      status: 'available',
      icon: <Package className="w-8 h-8" />,
      instructions: [
        'RHEL / FEDORA',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="space-y-1 text-sm">
              ...
              <a href="/downloads/agents/windows/SentinelAgentSetup-2.0.0.msi" className="text-primary hover:underline block">
                🪟 Windows (.msi) - 8.5MB
              </a>
              <a href="/downloads/agents/linux_deb/sentinel-agent_2.0.0_arm64.deb" className="text-primary hover:underline block">
                🐧 Linux DEB (.deb) - 9.3MB
              </a>
              <a href="/downloads/agents/linux_rpm/sentinel-agent-2.0.0.x86_64.rpm" className="text-primary hover:underline block">
                🐧 Linux RPM (.rpm) - 9.3MB
              </a>
            </div>
          </div>
