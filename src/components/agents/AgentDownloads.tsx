  ...
  const downloads: AgentDownload[] = [
    {
      ...
      version: '2.0.0',
      size: '24MB',
      url: 'https://storage.googleapis.com/sentinel-grc-a8701.firebasestorage.app/releases/agent/macos/SentinelAgent-2.0.0.pkg',
      status: 'available',
    ...
    },
    {
      ...
      version: '2.0.0',
      size: '8.5MB',
      url: 'https://storage.googleapis.com/sentinel-grc-a8701.firebasestorage.app/releases/agent/windows/SentinelAgentSetup-2.0.0.msi',
      status: 'available',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="space-y-1 text-sm">
              <a href="https://storage.googleapis.com/sentinel-grc-a8701.firebasestorage.app/releases/agent/macos/SentinelAgent-2.0.0.pkg" className="text-primary hover:underline block">
                🍎 macOS (.pkg) - 24MB
              </a>
