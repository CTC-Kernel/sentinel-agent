...
export const AuthGuard: React.FC<AuthGuardProps> = ({ children, requireOnboarding = true }) => {
 ...
 >
  ...
  className="w-full py-3 bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-3xl text-sm transition-all shadow-md flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary"
  >
