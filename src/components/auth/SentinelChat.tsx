...
const SentinelChat: React.FC = () => {
    const { t } = useLocale();
    // Lazy initialization - compute initial message once
        ...
        <div className="flex flex-col h-full relative z-20">
            ...
            <form onSubmit={handleSend} className="relative">
                ...
                <button
                    ...
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 bg-primary hover:bg-primary/80 text-white rounded-lg disabled:bg-muted disabled:text-muted-foreground disabled:border-border/40 disabled:cursor-not-allowed dark:disabled:border-border transition-colors shadow-md"
                >
                    <Send size={16} />
                </button>
            </form>
