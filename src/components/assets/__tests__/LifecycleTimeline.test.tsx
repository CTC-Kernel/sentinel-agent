...
describe('LifecycleTimeline', () => {
    ...
    describe('progress bar', () => {
        ...
        it('calculates correct progress width for Neuf (0%)', () => {
            ...
            const progressBar = container.querySelector('.bg-brand-500.h-1');
    ...
    describe('step styling', () => {
        it('applies completed styling to passed steps', () => {
            ...
            // Completed steps should have bg-brand-500 class
            const completedSteps = container.querySelectorAll('.bg-brand-500.rounded-full');
