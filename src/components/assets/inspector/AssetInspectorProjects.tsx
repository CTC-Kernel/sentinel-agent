...
export const AssetInspectorProjects: React.FC<AssetInspectorProjectsProps> = ({
 ...
 <div className="grid gap-4">
  ...
  <span className={`text-[11px] uppercase font-bold px-2.5 py-1 rounded-3xl ${proj.status === 'En cours' ? 'bg-blue-100 text-blue-700 dark:text-blue-400 ring-1 ring-blue-500/20' : 'bg-muted/500/10 text-muted-foreground ring-1 ring-slate-500/20'}`}>
   {proj.status}
  </span>
  </div>
