        ...
        <div className="space-y-6 sm:space-y-8">
            ...
            <div className="glass-premium p-6 rounded-3xl border border-border/40 shadow-sm">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="px-3 py-1 rounded-full bg-blue-50 dark:bg-slate-900/20 text-blue-600 dark:text-blue-400 text-xs font-bold">
            ...
            <div>
                <div className="flex items-center justify-between mb-4 px-1">
                    <h3 className="text-sm font-bold text-slate-900 dark:text-white flex items-center">
                        <ClipboardList className="h-4 w-4 mr-2 text-brand-500" /> {t('assets.lifecycle.history', 'Historique Maintenance')}
                    </h3>
                </div>
                {canEdit && (
                ...
                <div className="space-y-3">
                    {maintenanceRecords.length === 0 ? (
                        ...
                        maintenanceRecords.map(rec => (
                            <div key={rec.id || 'unknown'} className="flex items-start p-4 bg-white/50 dark:bg-slate-800/30 backdrop-blur-sm border border-border/40 dark:border-border/40 rounded-3xl shadow-sm hover:shadow-md transition-all">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center justify-between mb-1">
                                        ...
                                        <span className="text-[11px] uppercase tracking-wider bg-slate-100 dark:bg-white/10 px-2 py-0.5 rounded-3xl text-slate-600 dark:text-slate-300 font-bold">
