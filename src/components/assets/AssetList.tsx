                ...
                assets.map((asset) => {
                    ...
                    return (
                        <div
                            ...
                            role="button"
                            tabIndex={0}
                            className="glass-panel p-4 sm:p-6 rounded-3xl shadow-sm card-hover cursor-pointer group flex flex-col border border-muted/50 dark:border-white/5 hover:border-primary/30 transition-all relative overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
                        >
