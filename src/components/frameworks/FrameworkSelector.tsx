...
export const FrameworkSelector: React.FC<FrameworkSelectorProps> = ({ className }) => {
 ...
 <div className="flex items-center gap-2 px-4 py-2 rounded-3xl bg-muted/50 border border-border/40 dark:border-white/5">
 ...
 {/* Filter Tabs */}
 <div className="flex items-center gap-1 p-1 rounded-3xl bg-muted/50">
