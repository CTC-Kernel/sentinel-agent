...
export const ScheduleReportModal: React.FC<ScheduleReportModalProps> = ({
 ...
 {/* Report Name */}
 <div>
  <label htmlFor="scheduled-report-name" className="block text-sm font-medium text-foreground mb-2">
 ...
 {watchedFrequency === 'weekly' ? (
  <div>
  <label htmlFor="weekly-day" className="block text-sm font-medium text-foreground mb-2">
  ...
  <div>
  <label htmlFor="monthly-day" className="block text-sm font-medium text-foreground mb-2">
  <Calendar className="inline h-4 w-4 mr-1" />
  Jour du mois
  </label>
  <select
