            ...
            <div className="p-6">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="report-title" className="text-sm font-medium text-slate-700 dark:text-slate-300">
                            Titre du rapport
                        </label>
                        <input
                            id="report-title"
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className={`w-full flex items-center justify-between p-3 rounded-3xl border transition-all ${sections.includeRisks ? 'border-red-200 bg-red-50 dark:bg-red-900/20' : 'border-border/40 dark:border-border/40 opacity-60'}`}
                        >
                        ...
                        <button
                            ...
                            className={`w-full flex items-center justify-between p-3 rounded-3xl border transition-all ${sections.includeProjects ? 'border-blue-500/50 bg-blue-50 dark:bg-blue-900/20' : 'border-border/40 dark:border-border/40 opacity-60'}`}
                        >
                            <div className="flex items-center gap-3">
