...
function SortableSigner({
 ...
 <div className="flex items-center justify-center h-8 w-8 rounded-full bg-primary/15 dark:bg-primary text-primary text-sm font-medium">
 {index + 1}
 </div>
...
export function SignatureWorkflow({
 ...
 <div className="border-2 border-dashed border-border/40 rounded-3xl overflow-hidden bg-white">
  <SignatureCanvas
  ref={signaturePadRef}
  canvasProps={{
  width: 450,
