...
export const FolderTree: React.FC<FolderTreeProps> = ({
 ...
 <div
  className={`flex items-center py-2 px-3 rounded-lg cursor-pointer mb-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${selectedFolderId === null ? 'bg-muted text-foreground font-bold ring-1 ring-slate-200 dark:ring-slate-700' : 'hover:bg-muted/50 dark:hover:bg-muted/50 text-foreground'}`}
 ...
 >
  ...
  <input
   ...
   } mb-1 focus-visible:ring-2 focus-visible:ring-primary outline-none`}
  />
  {errors.name && (
...
const FolderNode = React.memo(({
 ...
 <div
 className={`flex items-center py-2 px-3 rounded-lg cursor-pointer transition-colors group relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${isSelected ? 'bg-muted text-foreground font-bold' : 'hover:bg-muted/50 dark:hover:bg-muted/50 text-foreground'}`}
 ...
 {isEditing ? (
  ...
  aria-label="Renommer le dossier"
  type="text"
  className="flex-1 bg-card border border-primary rounded px-2 py-0.5 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
