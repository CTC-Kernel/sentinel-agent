        ...
        <div className={`group relative p-6 rounded-3xl border transition-all duration-300 ${isConnected
            ...
            <div className="flex items-center justify-between mt-auto relative z-10">
                <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-3xl text-sm font-bold transition-all flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-900 ${isConnected
