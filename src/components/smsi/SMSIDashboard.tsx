...
const PhaseDetailsPanel: React.FC<PhaseDetailsPanelProps> = ({ phase, program, milestones }) => {
 ...
 <div className="flex-1">
  ...
  <h3 className="text-xl font-bold text-foreground">Phase {config.label}</h3>
  <Badge
  status={
  ...
  <div className="text-2xl font-bold text-foreground">{phaseData.progress}%</div>
  <div className="text-sm text-muted-foreground">Progression</div>
  </div>
  <div className="glass-premium p-4 rounded-3xl border border-border/40">
  <div className="text-2xl font-bold text-foreground">{completedMilestones}/{milestones.length}</div>
