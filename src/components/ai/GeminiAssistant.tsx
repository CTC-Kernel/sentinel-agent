...
export const GeminiAssistant: React.FC = () => {
    ...
    return (
        <div className={cn(
            ...
            {/* Header */}
            <div className="p-4 border-b border-border/40 dark:border-white/5 flex justify-between items-center bg-gradient-to-r from-brand-50/50 to-violet-50/50 dark:from-brand-900/20 dark:to-violet-900/20">
                <div className="flex items-center gap-3">
                    <div className="p-2.5 bg-gradient-to-br from-brand-500 to-violet-600 rounded-3xl shadow-lg shadow-brand-500/20">
                ...
                <div className="flex items-center gap-1">
                    <button
                        ...
                        className="hidden md:block p-2 hover:bg-slate-200/50 dark:hover:bg-white/10 rounded-3xl text-slate-600 dark:text-muted-foreground transition-colors"
                    ...
                    <button
                        ...
                        className="p-2.5 hover:bg-rose-100/50 dark:hover:bg-rose-900/20 hover:text-rose-600 rounded-3xl text-slate-600 dark:text-muted-foreground transition-colors"
                        title="Fermer"
            ...
            {/* Input Area */}
            <form onSubmit={(e) => { e.preventDefault(); handleSend(e); }} className="p-4 bg-white/50 dark:bg-slate-900/50 backdrop-blur-md border-t border-border/40 dark:border-white/5">
                    ...
                    <div className="relative flex-1">
                        ...
                        <div className="absolute right-3 top-1/2 -translate-y-1/2">
                            {isLoading ? (
                                ...
                                <div className="text-[11px] font-bold text-slate-300 border border-border/40 dark:border-slate-700 rounded px-1.5 py-0.5 pointer-events-none">
                                    ⏎
                                </div>
                            )}
                        </div>
