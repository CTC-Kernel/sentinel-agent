                                ...
                                category.items.map((item) => (
                                    ...
                                    >
                                        <div className="relative z-10 flex items-center justify-between gap-2">
                                            ...
                                            {item.meta && (
                                                <span className={`text-[9px] px-1.5 py-0.5 rounded bg-white/5 border border-white/5 ${selectedNodeId === item.id ? 'text-indigo-200' : 'text-white/30 group-hover:text-white/50'
                                                    }`}>
                                                    {item.meta}
                                                </span>
                                            )}
                                        ...
                                        {selectedNodeId === item.id && (
                                            <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-indigo-500 shadow-[0_0_8px_currentColor]" />
                                        )}
                                    </button>
                                ))
                            )}
