...
export const AnomalyPanel: React.FC<AnomalyPanelProps> = ({
  ...
  return (
    <motion.aside
      ...
      className="fixed inset-y-0 right-0 w-96 bg-slate-950/95 border-l border-white/10 backdrop-blur-2xl z-50 flex flex-col shadow-[-20px_0_50px_rgba(0,0,0,0.3)]"
    >
      {/* Header */}
