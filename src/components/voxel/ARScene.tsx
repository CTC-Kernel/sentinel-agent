...
export const ARScene: React.FC<ARSceneProps> = ({
 ...
 {/* AR Entry Button */}
 <ARButton
 className="absolute bottom-4 right-4 z-decorator px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-3xl shadow-lg transition-colors"
 sessionInit={{
 ...
 <div className="absolute top-4 left-4 z-decorator bg-card/80 backdrop-blur-sm border border-border/40 rounded-lg px-4 py-2">
 <div className="flex items-center gap-2">
 <svg
