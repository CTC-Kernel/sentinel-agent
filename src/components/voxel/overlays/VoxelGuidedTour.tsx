          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <button
                ...
                className="min-w-[44px] min-h-[44px] p-2 rounded-lg hover:bg-slate-700/50 disabled:bg-slate-800 disabled:text-slate-600 disabled:cursor-not-allowed transition-colors"
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handleSkip}
                className="px-3 py-1.5 text-xs text-slate-500 dark:text-slate-400 hover:text-slate-300 transition-colors flex items-center gap-1"
              >
