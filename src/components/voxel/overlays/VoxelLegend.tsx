      ...
      >
        ...
        {isExpanded && (
          ...
          >
            {/* Node Types */}
            <section>
              <h3 className="text-xs font-medium uppercase tracking-wide text-slate-500 dark:text-slate-300 mb-2">
                Entity Types
              </h3>
                ...
                {NODE_TYPE_LEGEND.map(({ type, label, color, shape, icon, shapeIcon }) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-xs text-slate-500 dark:text-slate-300 ml-2">({shape})</span>
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div className="space-y-1">
                  {STATUS_LEGEND.map(({ status, label, color, description }) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <span className="text-sm text-slate-200">{label}</span>
                        <span className="text-xs text-slate-500 dark:text-slate-300 block">{description}</span>
                      </div>
                    </div>
                  ))}
                </div>
