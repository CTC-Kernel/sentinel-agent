...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
 ...
 case 'cloud': return <Cloud className={`${baseClass} text-muted-foreground`} />;
 ...
 purple: {
 bg: 'bg-muted',
 bgHover: 'group-hover/card:bg-muted dark:group-hover/card:bg-slate-700',
 iconBg: 'bg-muted shadow-sm ring-1 ring-inset ring-slate-200 dark:ring-slate-700',
 ...
 <div className="relative z-10 p-6 md:p-8 lg:p-10">
  ...
  <div className="relative shrink-0 group/orb cursor-default">
   {/* Outer Glow Ring */}
   <div className="absolute -inset-4 bg-gradient-to-r from-primary/30 via-info-500/30 to-primary/30 rounded-[2.5rem] blur-2xl opacity-0 group-hover/orb:opacity-70 transition-all duration-700 animate-pulse-slow" />
   ...
   <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-card backdrop-blur-xl flex items-center justify-center shadow-lg shadow-success/20 border-2 border-white">
  ...
  >
   ...
   {getGreeting()}, <span className="text-foreground font-semibold">{user?.displayName || t('common.user', { defaultValue: 'Utilisateur' })}</span>
   </p>
   <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black font-display text-foreground tracking-tight leading-none">
  ...
  >
   ...
   {/* Séparateur vertical */}
   <div className="hidden sm:block w-px h-10 bg-gradient-to-b from-transparent via-border dark:via-slate-600 to-transparent" />
  ...
  {/* Quick Actions Group */}
  <div className="flex items-center gap-1 p-1 bg-card/40 rounded-3xl border border-border/40 shadow-sm backdrop-blur-xl">
   {onToggleEdit && (
   ...
   className="p-2.5 rounded-3xl text-muted-foreground hover:text-foreground/60 hover:bg-muted/50 transition-all duration-300 disabled:bg-muted disabled:text-muted-foreground"
   ...
   className="p-2.5 rounded-2xl text-muted-foreground hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition-all duration-300"
  ...
  <Tooltip content="Télécharger les agents" position="bottom">
   ...
   className="flex items-center gap-2 px-4 py-2.5 bg-card hover:bg-slate-800 text-white /40 text-xs font-bold rounded-3xl shadow-sm hover:shadow-md transition-all duration-300 border border-border/40"
  ...
  className="p-4 rounded-3xl bg-muted/50/80 border border-border/40 backdrop-blur-sm"
  >
  ...
  className={`rounded-3xl cursor-pointer group/deadline transition-all duration-300 bg-muted/50/40/40 border border-border/40 hover:border-primary/50 dark:hover:border-primary/60/50 hover:bg-white/60 shadow-sm backdrop-blur-xl`}
  onClick={() => nextDeadline?.link && navigate(nextDeadline.link)}
  >
  <div className="flex items-start gap-4 p-4">
   <div className="p-2.5 rounded-2xl shrink-0 bg-white/60/50 border border-border/20 shadow-sm group-hover/deadline:scale-110 transition-transform">
   {nextDeadline ? (
   ...
   <div className="flex items-center gap-1.5 shrink-0 px-2.5 py-1 rounded-full bg-primary/10/30 border border-primary/20/50 dark:border-primary/90/50">
    <Calendar className="h-3 w-3 text-primary" />
    <span className="text-[11px] font-black text-primary dark:text-primary/50">
   ...
   {nextDeadline && (
   <ArrowRight className="h-4 w-4 text-muted-foreground opacity-0 group-hover/deadline:opacity-70 transition-opacity shrink-0 translate-x-1 group-hover/deadline:translate-x-0 transition-transform" />
   )}
  </div>
  </motion.div>
  </div>
  ...
  >
   ...
   <p className="text-xs font-medium text-muted-foreground truncate">{insight.details}</p>
   </div>
   <div className="p-2 rounded-xl bg-white/60 opacity-0 group-hover/insight:opacity-100 transition-all duration-300 translate-x-1 group-hover/insight:translate-x-0">
