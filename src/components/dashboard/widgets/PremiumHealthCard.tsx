...
export const PremiumHealthCard: React.FC<PremiumHealthCardProps> = ({
    ...
    if (loading) {
        return (
            <div className="glass-premium p-6 rounded-4xl border border-border/40 animate-pulse">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {[...Array(3)].map((_, i) => (
                                <div key={i || 'unknown'} className="h-20 bg-muted rounded-3xl" />
                            ))}
                        </div>
                    </div>
                </div>
            ...
            <div className="relative z-decorator">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        <div className="p-2.5 rounded-3xl bg-gradient-to-br from-primary to-violet-600 shadow-lg shadow-primary/20">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-6">
                    ...
                    >
                        <div className="relative w-36 h-36 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50">
                            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={undefined}>
                                <PieChart margin={{ top: 0, right: 0, bottom: 0, left: 0 }}>
                                    ...
                                    >
                                        <Cell
                                            fill={complianceGaugeData[0].fill}
                        ...
                        <div className="absolute inset-0 rounded-full bg-transparent group-hover:bg-primary/10 transition-colors" />
                    </div>

                    {/* Divider */}
                    <div className="hidden lg:block w-px h-28 bg-gradient-to-b from-transparent via-border to-transparent" />
                    ...
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
                        ...
                        <motion.div
                            ...
                            className="p-4 bg-white/50 dark:bg-white/5 rounded-2xl border border-border/40 cursor-pointer group"
