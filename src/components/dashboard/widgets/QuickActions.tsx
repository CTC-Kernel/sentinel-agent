...
export const QuickActions: React.FC<QuickActionsProps> = ({ navigate, t, stats }) => {
    return (
        <div className="grid grid-cols-2 md:grid-cols-5 gap-5">
            <button onClick={() => navigate('/ctc-engine')} className="relative p-5 bg-card border border-border rounded-2xl flex flex-col items-center justify-center gap-3 hover:scale-[1.05] hover:shadow-xl transition-all duration-300 group shadow-sm hover:border-purple-300 dark:hover:border-purple-500/50 active:scale-95">
            ...
            <button onClick={() => navigate('/team')} className="relative p-5 bg-card border border-border rounded-2xl flex flex-col items-center justify-center gap-3 hover:scale-[1.05] hover:shadow-xl transition-all duration-300 group shadow-sm hover:border-emerald-300 dark:hover:border-emerald-500/50 active:scale-95">
