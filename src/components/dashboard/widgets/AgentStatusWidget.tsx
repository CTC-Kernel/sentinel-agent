            ...
            <div className="p-4 h-full overflow-y-auto custom-scrollbar">
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-6 bg-slate-100/50 dark:bg-slate-800/30 rounded-2xl border border-border/40 dark:border-slate-700/30 backdrop-blur-sm">
                        <Monitor className="h-10 w-10 text-slate-600 dark:text-slate-600 mb-3" />
                    ...
                    <div className="space-y-4">
                        ...
                        {averageComplianceScore !== null && (
                            <div className="p-4 bg-gradient-to-r from-brand-50 to-brand-100/50 dark:from-brand-900/20 dark:to-brand-900/10 rounded-2xl border border-brand-100 dark:border-brand-800">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                        <div className="text-xs text-slate-600 dark:text-muted-foreground mb-1">
                            ...
                            {displayAgents.map(agent => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <span className="text-[11px] text-slate-600 dark:text-slate-300 uppercase">
