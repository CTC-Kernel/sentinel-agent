...
export const ComplianceEvolutionWidget: React.FC<ComplianceEvolutionWidgetProps> = React.memo(({ historyData, loading, t, theme }) => {
 ...
 >
  ...
  className={`px-2 py-1 text-xs font-bold rounded-md transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${timeRange === range
