...
export const TrainingOverdueList: React.FC<TrainingOverdueListProps> = ({
 ...
 >
  ...
  <User className="w-5 h-5 text-muted-foreground group-hover:text-red-500 transition-colors" />
  </div>
  ...
  <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-red-100 dark:bg-red-900/30 dark:bg-red-900/20 text-xs font-bold text-red-600 dark:text-red-400">
  ...
  className="shrink-0 opacity-0 group-hover:opacity-70 transition-all transform translate-x-2 group-hover:translate-x-0 bg-card shadow-sm border-border/40 hover:border-red-2000 hover:text-red-600 dark:hover:text-red-400"
  >
