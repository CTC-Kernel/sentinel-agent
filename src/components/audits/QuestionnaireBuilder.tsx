...
export const QuestionnaireBuilder: React.FC<QuestionnaireBuilderProps> = ({ auditId, organizationId, onClose, onSave, initialData }) => {
 ...
 <div className="border-t border-border/40 pt-6">
  ...
  onClick={addQuestion}
  className="flex items-center px-4 py-2 bg-muted dark:bg-white/10 text-foreground dark:text-white rounded-3xl text-sm font-bold hover:bg-muted dark:hover:bg-white/20 transition-colors"
  >
  ...
  <div key={q.id || 'unknown'} className="bg-muted/50 p-6 rounded-3xl border border-border/40 relative group">
  <div className="absolute left-2 top-1/2 -translate-y-1/2 text-muted-foreground cursor-move opacity-0 group-hover:opacity-70 transition-opacity">
  ...
  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 pl-6">
   ...
   <div className="md:col-span-12 pl-4 border-l-2 border-primary/30">
   <div className="text-xs font-bold uppercase text-muted-foreground mb-2 block">Options de réponse</div>
   ...
   <button
    ...
    className="text-xs font-bold text-primary hover:text-primary flex items-center mt-2"
   >
   ...
   type="checkbox"
   className="rounded border-border/40 text-primary focus-visible:ring-primary transition-colors"
   />
   <span className="text-sm text-muted-foreground group-hover:text-foreground dark:group-hover:text-white transition-colors">Obligatoire</span>
   </label>
   </div>
  </div>
  </div>
 ...
 <button
  ...
  onClick={onClose}
  className="px-4 py-2 text-muted-foreground font-bold hover:bg-muted rounded-3xl transition-colors"
 >
  Annuler
 </button>
 <button
  ...
  onClick={handleSave}
  disabled={saving}
  className="flex items-center px-6 py-2 bg-primary text-primary-foreground rounded-3xl font-bold hover:bg-primary/90 transition-colors disabled:bg-muted disabled:text-muted-foreground shadow-lg shadow-primary/20"
 >
