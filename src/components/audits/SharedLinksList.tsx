    ...
    return (
        <div className="space-y-3">
            {links.map(link => {
                ...
                return (
                    <div key={link.id || 'unknown'} className={`flex items-center justify-between p-3 rounded-lg border ${isActive ? 'bg-white dark:bg-slate-800 border-border/40 dark:border-border/40' : 'bg-slate-50 dark:bg-slate-900 border-border/40 dark:border-white/5 opacity-75'}`}>
