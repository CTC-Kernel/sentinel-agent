...
export const AuditTrailViewer: React.FC = () => {
 ...
 case 'update': return 'bg-info-bg text-info-text';
 ...
 <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
  ...
  className="w-full pl-10 pr-4 py-2 bg-muted border border-border/40 rounded-3xl text-sm focus-visible:ring-2 focus-visible:ring-primary outline-none"
  />
  </div>
  ...
  className="px-4 py-2 bg-background border border-border rounded-3xl text-sm focus-visible:ring-2 focus-visible:ring-primary focus-visible:border-transparent"
 ...
 <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
  ...
  type="date"
  className="w-full pl-10 pr-4 py-2 bg-background border border-border rounded-3xl text-sm focus-visible:ring-2 focus-visible:ring-primary focus-visible:border-transparent"
  />
  </div>
  <div className="relative">
  <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
