...
export const AuditLinkedItems: React.FC<AuditLinkedItemsProps> = ({
 ...
 <div className="text-center py-8">
  ...
  <p className="text-sm text-muted-foreground">Aucun élément lié à cet audit</p>
 ...
 <div className="glass-premium p-4 sm:p-6 rounded-3xl border border-border/40 shadow-sm">
  ...
  <div
   key={ctrl.id || 'unknown'}
   className="flex items-center justify-between p-3 bg-card/40 backdrop-blur-sm rounded-3xl border border-border/40 shadow-sm group hover:shadow-md hover:border-primary/30 transition-all"
  >
