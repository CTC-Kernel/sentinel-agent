                        ...
                        <button
                            ...
                            className={`
                                ...
                                ${isSelected
                                    ...
                                    : 'bg-slate-50 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 hover:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary'
                                }
                            `}
                        >
                            <div className={`
                            ...
                            <span className={`text-[11px] font-bold uppercase tracking-wide ${isSelected ? 'text-slate-900 dark:text-white' : 'text-slate-500'}`}>
                                {opt.label}
                            </span>
                        </button>
                    );
