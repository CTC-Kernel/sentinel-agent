    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                    <h4 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4">Catégories de Données</h4>
                ...
                <div>
                    <h4 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4">Conservation</h4>
