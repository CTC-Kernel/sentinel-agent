...
export const PrivacyDetails: React.FC<PrivacyDetailsProps> = ({
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
  ...
  placeholder={t('privacy.details.activityNamePlaceholder', { defaultValue: 'Ex: Gestion de la paie' })}
  icon={Tag}
  />
  </div>
  <div>
 ...
 <div>
  ...
  <div className="bg-white dark:bg-white/5 p-4 rounded-3xl border border-border/40 space-y-3">
  <div className="flex items-center gap-3">
  <User className="h-4 w-4 text-primary" />
  <div>
  <p className="text-xs text-muted-foreground">{t('privacy.fields.manager', { defaultValue: 'Responsable' })}</p>
