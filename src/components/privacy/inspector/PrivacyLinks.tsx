                    ...
                    {isEditing && (
                        <div className="relative">
                            <select
                                ...
                                className="pl-3 pr-8 py-2 bg-white dark:bg-slate-800 border border-border/40 dark:border-slate-700 rounded-lg text-sm focus:ring-2 focus-visible:ring-primary appearance-none cursor-pointer"
                                defaultValue=""
                            >
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2 text-xs mt-1">
                                                <span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-700 rounded text-slate-600 dark:text-muted-foreground">
