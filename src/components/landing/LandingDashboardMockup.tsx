...
export const LandingDashboardMockup: React.FC = () => {
 ...
 <div className="flex-1 p-6 overflow-hidden relative">
  ...
  {[40, 55, 45, 60, 75, 65, 80, 70, 85, 90, 82, 88].map((h, i) => (
   ...
   <div
   className="w-full bg-primary/15 group-hover:bg-primary/20 transition-all duration-500 rounded-t-sm relative"
   style={{ height: `${h}%` }}
   >
   <div
  ...
  <div className="absolute inset-0 bg-gradient-to-t from-muted/50/20 via-transparent to-transparent pointer-events-none"></div>
 </div>
 </div>
 </div>
 );
