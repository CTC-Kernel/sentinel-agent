...
export const HolographicShield = () => {
    return (
        <div className="relative w-96 h-96 flex items-center justify-center pointer-events-none select-none perspective-1000">
            {/* Outer Rotating Ring */}
            <div className="absolute inset-0 rounded-full border border-brand-200 border-t-brand-500/60 border-b-brand-500/60 animate-[spin_10s_linear_infinite] shadow-[0_0_30px_rgba(59,130,246,0.2)]"></div>
            ...
            {/* Pulsing Core Field */}
            <div className="absolute inset-20 rounded-full bg-brand-500/30 dark:bg-brand-400/20 blur-3xl animate-pulse"></div>

            {/* Center Emblem */}
            <div className="relative z-10 p-8 rounded-full bg-slate-900/50 backdrop-blur-md border border-brand-300 shadow-[0_0_50px_rgba(59,130,246,0.3)] animate-float">
            ...
            <div className="absolute inset-0 overflow-hidden rounded-full opacity-30">
                <div className="w-full h-[2px] bg-brand-200 blur-[1px] animate-[scanline_3s_linear_infinite] shadow-[0_0_10px_rgba(59,130,246,0.5)]"></div>
            </div>
