...
export const SystemEntrance: React.FC = () => {
 ...
 if (isBooting) {
 return (
 <div className="min-h-screen bg-muted text-green-600 dark:text-green-400 font-mono flex items-center justify-center p-8 transition-colors duration-500">
 <div className="w-full max-w-lg">
  {bootSequence.map((line, i) => (
  <div key={`msg-${i || 'unknown'}`} className="mb-2 animate-fade-in font-bold">
 ...
 return (
 <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-muted text-foreground selection:bg-primary selection:text-white transition-colors duration-700">
 ...
 <div className={cn(
  ...
  <div className="mt-6 font-mono text-sm tracking-widest text-muted-foreground font-bold uppercase">
  Chargement...
  </div>
  </div>
  )}
  ...
  size="lg"
  className="w-full h-14 bg-muted text-foreground hover:bg-muted font-bold tracking-tight text-lg rounded-3xl shadow-none hover:scale-[1.01] transition-all group border border-transparent dark:border-white/5 relative z-30"
  >
