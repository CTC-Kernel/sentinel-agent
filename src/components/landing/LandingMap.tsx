...
export const LandingMap: React.FC<LandingMapProps> = memo(({ className }) => {
 ...
 <ZoomableGroup center={[0, 0]}>
  ...
  <Geography
   ...
   geography={geo}
   className="fill-muted-foreground/50/80 dark:fill-foreground/80 stroke-muted-foreground/60 dark:stroke-foreground/60 outline-none transition-colors duration-700"
   style={{
