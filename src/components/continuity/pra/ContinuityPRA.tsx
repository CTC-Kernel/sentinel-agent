...
export const ContinuityPRA: React.FC<ContinuityPRAProps> = ({
 ...
 <div>
  <h2 className="text-xl font-bold text-foreground">{t('continuity.pra.titleFull', { defaultValue: "Plans de Reprise d'Activité (PRA)" })}</h2>
  <p className="text-sm text-muted-foreground">{t('continuity.pra.subtitle', { defaultValue: 'Gérez vos procédures de restauration et de continuité.' })}</p>
 </div>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
  {[1, 2, 3].map(i => (
  <div key={i || 'unknown'} className="h-64 rounded-2xl bg-muted animate-pulse" />
  ))}
 </div>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
  ...
  <div className="min-w-0">
   <h3 className="font-bold text-foreground truncate" title={plan.title}>{plan.title}</h3>
   <div className="mt-1">
  ...
  <div className="bg-muted/50 dark:bg-white/5 p-2 rounded-lg text-center">
   <span className="block text-xs uppercase text-muted-foreground font-bold mb-1">RTO</span>
   <span className="font-mono font-bold text-foreground text-muted-foreground">{plan.rto}</span>
  </div>
  <div className="bg-muted/50 dark:bg-white/5 p-2 rounded-lg text-center">
   <span className="block text-xs uppercase text-muted-foreground font-bold mb-1">RPO</span>
   <span className="font-mono font-bold text-foreground text-muted-foreground">{plan.rpo}</span>
  </div>
  </div>
