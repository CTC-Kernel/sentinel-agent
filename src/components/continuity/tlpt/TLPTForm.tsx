...
export const TLPTForm: React.FC<TLPTFormProps> = ({
 ...
 <h3 className="text-lg font-bold text-foreground mb-6">Informations Générales</h3>
 ...
 <div className="flex justify-end gap-3 pt-4">
  ...
  type="submit"
  disabled={isLoading}
  className="gap-2 bg-gradient-to-r from-primary to-indigo-600 hover:from-primary hover:to-indigo-700 text-white rounded-3xl shadow-lg shadow-primary/20 font-bold"
  >
