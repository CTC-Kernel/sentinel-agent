...
export const TlptFindings: React.FC<TlptFindingsProps> = ({ campaign }) => {
 ...
 <Button onClick={() => { setEditingVuln(undefined); setIsFormOpen(true); }} size="sm" className="bg-primary text-primary-foreground">
 ...
 <div className="grid gap-3">
  ...
  className="p-4 rounded-3xl border border-border/40 bg-white dark:bg-white/5 hover:border-primary transition-colors cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
