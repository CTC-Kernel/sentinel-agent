...
export const ContinuitySummaryCard: React.FC<ContinuitySummaryCardProps> = ({ processes, drills }) => {
 ...
 return (
 <div className="glass-premium p-6 md:p-8 rounded-3xl border border-border/40 dark:border-white/5 flex flex-col xl:flex-row gap-8 relative group overflow-hidden bg-gradient-to-br from-white/40 to-white/10 dark:to-transparent">
