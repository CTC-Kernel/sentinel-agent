...
export const ContinuityDrills: React.FC<ContinuityDrillsProps> = ({ drills, processes, loading, onNewDrill }) => {
    ...
    return (
        <motion.div variants={slideUpVariants} initial="initial" animate="visible" className="space-y-6">
            <div className="flex justify-between items-center bg-white dark:bg-slate-800 p-4 rounded-[2rem] border border-slate-200 dark:border-white/10 shadow-sm">
                ...
                <button
                    onClick={onNewDrill}
                    className="flex items-center px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white rounded-xl font-bold transition-all shadow-lg shadow-brand-600/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-600"
                >
