                                    ...
                                    return (
                                        <tr key={drill.id} className="hover:bg-white/60 dark:hover:bg-slate-800/40 transition-colors group">
                                            <td className="px-4 sm:px-8 py-5 text-slate-900 dark:text-white font-bold flex items-center">
                                                <div className="p-2 bg-white dark:bg-slate-800 rounded-xl mr-3 shadow-sm border border-slate-100 dark:border-white/5 group-hover:scale-110 transition-transform">
                                            ...
                                            <td className="px-6 py-5">
                                                <span className="px-3 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-lg text-xs font-bold border border-slate-200 dark:border-white/5 shadow-sm">
                                                    {drill.type}
                                                </span>
                                            </td>
                                            <td className="px-6 py-5">
