...
import { X, Edit2, Trash2, HeartPulse, Clock, Server, Truck, AlertTriangle, Zap } from 'lucide-react';
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-y-0 right-0 w-full max-w-2xl bg-white dark:bg-[#0F1115] z-50 shadow-2xl border-l border-gray-200 dark:border-white/10 overflow-y-auto"
                    >
                        <div className="p-6 md:p-8">
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    ...
                                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white leading-tight">{process.name}</h2>
                                    <p className="text-sm text-slate-500 mt-1">Géré par {process.owner}</p>
                                </div>
                                <button onClick={onClose} className="p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/10 rounded-full transition-colors">
                                    <X className="h-5 w-5" />
                                </button>
                            </div>
                        ...
                        {/* Footer Actions */}
                        <div className="p-6 border-t border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/5 flex justify-between">
