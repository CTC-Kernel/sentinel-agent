...
export const ProcessInspector: React.FC<ProcessInspectorProps> = ({
 ...
 <div className="flex gap-2">
  ...
  className="text-muted-foreground hover:text-primary hover:bg-primary/10 dark:hover:bg-primary"
  aria-label={t('continuity.inspector.editProcess', { defaultValue: 'Modifier le processus' })}
  >
  ...
  aria-label={isDeleting ? t('common.deleting', { defaultValue: 'Suppression en cours' }) : t('continuity.inspector.deleteProcess', { defaultValue: 'Supprimer le processus' })}
  >
