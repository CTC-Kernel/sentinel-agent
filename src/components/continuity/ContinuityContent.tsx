                            ...
                            actions={
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        className="p-2 bg-white dark:bg-slate-800 border border-border/40 dark:border-border/40 text-slate-700 dark:text-white rounded-3xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                                    >
