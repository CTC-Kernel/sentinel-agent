...
export const ProcessDependencies: React.FC<ProcessDependenciesProps> = ({ linkedAssets, linkedSuppliers, linkedRisks }) => {
 ...
 <div className="flex flex-wrap gap-2">
  ...
  )) : <p className="text-sm text-muted-foreground italic">{t('continuity.dependencies.noAssets', { defaultValue: 'Aucun actif support lié.' })}</p>}
 </div>
 </div>
 ...
 <div className="flex flex-wrap gap-2">
  ...
  )) : <p className="text-sm text-muted-foreground italic">{t('continuity.dependencies.noSuppliers', { defaultValue: 'Aucun fournisseur lié.' })}</p>}
 </div>
 </div>
 ...
 <div className="grid gap-3">
  ...
  )) : <p className="text-sm text-muted-foreground italic">{t('continuity.dependencies.noRisks', { defaultValue: 'Aucun risque associé.' })}</p>}
 </div>
 </div>
 </div>
 );
