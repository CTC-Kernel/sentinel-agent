        ...
        <div className="space-y-6 sm:space-y-8">
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    )) : <p className="text-sm text-muted-foreground italic">Aucun actif support lié.</p>}
                </div>
            </div>
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    )) : <p className="text-sm text-muted-foreground italic">Aucun fournisseur lié.</p>}
                </div>
            </div>
            ...
            <div>
                ...
                <div className="grid gap-3">
                    ...
                    )) : <p className="text-sm text-muted-foreground italic">Aucun risque associé.</p>}
                </div>
            </div>
        </div>
    );
