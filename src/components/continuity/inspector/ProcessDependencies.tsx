            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2">
                    {linkedAssets.length > 0 ? linkedAssets.map(a => (
                        <div key={a.id} className="p-3 bg-white dark:bg-white/5 rounded-3xl border border-border/40 dark:border-border/40 shadow-sm flex items-center gap-2">
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2">
                    {linkedSuppliers.length > 0 ? linkedSuppliers.map(s => (
                        <div key={s.id} className="p-3 bg-white dark:bg-white/5 rounded-3xl border border-border/40 dark:border-border/40 shadow-sm flex items-center gap-2">
            ...
            <div>
                ...
                <div className="grid gap-3">
                    {linkedRisks.length > 0 ? linkedRisks.map(r => (
                        <div key={r.id} className="flex justify-between items-center p-4 bg-white dark:bg-white/5 rounded-3xl border border-border/40 dark:border-border/40 shadow-sm">
