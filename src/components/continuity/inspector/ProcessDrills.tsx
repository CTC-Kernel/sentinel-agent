        ...
        <div className="space-y-6">
            ...
            {drills.length > 0 ? (
                <div className="space-y-3">
                    {drills.map(d => (
                        <div key={d.id} className="flex items-center justify-between p-4 bg-white dark:bg-white/5 rounded-3xl border border-border/40 dark:border-border/40 shadow-sm hover:border-brand-200 transition-colors">
