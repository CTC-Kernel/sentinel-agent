        ...
        <div className="space-y-6">
            ...
            {drills.length > 0 ? (
                <div className="space-y-3">
                    {drills.map(d => (
                        <div key={d.id || 'unknown'} className="flex items-center justify-between p-4 bg-white dark:bg-white/5 rounded-3xl border border-border/40 dark:border-border/40 shadow-sm hover:border-brand-200 transition-colors">
                ...
                <div className="flex flex-col items-center justify-center py-12 text-slate-400 border-2 border-dashed border-border/40 dark:border-border/40 rounded-2xl">
                    <Zap className="h-8 w-8 mb-2 opacity-60" />
