...
export const MigrationTool: React.FC = () => {
    ...
    return (
        <div className="glass-premium rounded-2xl p-6 border border-border/40">
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-3xl p-4 mb-6 font-mono text-xs h-48 overflow-y-auto border border-border/40 dark:border-slate-700">
                {logs.length === 0 ? (
