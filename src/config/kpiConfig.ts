...
export const KPI_DEFINITIONS: Record<KPIType, KPIDefinition> = {
  score_global: {
    id: 'score_global',
    title: 'Santé Conformité',
    technicalKey: 'complianceScore.global',
    subtitleTemplate: 'Score global de sécurité',
    i18nKey: 'kpi.score_global',
    icon: 'shield-check',
    description: 'Score de conformité global de 0 à 100',
  },
  risques_critiques: {
    id: 'risques_critiques',
    title: 'Points d\'Attention',
    technicalKey: 'risks.critical.count',
    subtitleTemplate: '{count} nécessite(nt) votre attention',
    i18nKey: 'kpi.risques_critiques',
    icon: 'alert-triangle',
    description: 'Nombre de risques critiques à traiter',
  },
  audits_en_cours: {
    id: 'audits_en_cours',
    title: 'Contrôles Actifs',
    technicalKey: 'audits.in_progress.count',
    subtitleTemplate: '{count} vérification(s) en cours',
