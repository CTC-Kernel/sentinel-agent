...
export const Integrations: React.FC = () => {
 ...
 <div className="bg-muted/50 p-1 rounded-2xl inline-flex relative">
  <div
  className="absolute inset-y-1 bg-card/80 rounded-xl shadow-lg transition-all duration-300 ease-spring"
  style={{
 ...
 <>
  ...
  className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all duration-300 text-primary hover:bg-primary/10 dark:hover:bg-primary/30"
  >
