...
export const Dashboard: React.FC = () => {
    ...
    const { data: historyStats, loading: historyLoading } = useFirestoreCollection<DailyStat>('stats_history', [where('organizationId', '==', user?.organizationId || 'ignore'), orderBy('date', 'desc'), limit(60)], { logError: true, realtime: true, enabled: needsGlobalStats || isAuditor });
