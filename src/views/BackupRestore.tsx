...
export const BackupRestore: React.FC = () => {
 ...
 actions={
 <div className="flex bg-muted p-1 rounded-xl max-w-full overflow-x-auto">
 <Button
 variant="ghost"
 ...
 <div className="text-center py-12 border-2 border-dashed border-border rounded-2xl">
  ...
  <p className="text-muted-foreground font-medium">Sélectionnez une sauvegarde dans la liste pour commencer</p>
 </div>
 ) : (
 <form onSubmit={restoreForm.handleSubmit(handleRestore)} className="space-y-6">
  ...
  <div className="flex items-center justify-between gap-3 p-3 rounded-xl hover:bg-muted/50">
  <div>
  <span className="block font-medium text-foreground">Écraser les données existantes</span>
  <span className="text-xs text-muted-foreground">Si coché, les données actuelles seront remplacées par celles de la sauvegarde.</span>
  </div>
  <Controller
  ...
  <div className="flex items-center justify-between gap-3 p-3 rounded-xl hover:bg-muted/50">
  <div>
  <span className="block font-medium text-foreground">Simulation (Dry Run)</span>
  <span className="text-xs text-muted-foreground">Vérifie l'intégrité sans modifier les données.</span>
  </div>
  <Controller
  control={restoreForm.control}
  name="dryRun"
