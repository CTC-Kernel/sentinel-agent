                ...
                <div className="flex items-center gap-6 relative z-decorator">
                    <div className="relative group/ring">
                        ...
                        <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">
                            ...
                            <span className="text-[11px] font-bold text-slate-500 dark:text-slate-300 uppercase tracking-widest">{t('team.stats.activeLabel', { defaultValue: 'Actif' })}</span>
                        </div>
                    </div>
                    <div>
                        <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-1 tracking-tight">{t('team.overview', { defaultValue: 'Vue d\'ensemble' })}</h2>
