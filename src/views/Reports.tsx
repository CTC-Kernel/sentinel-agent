...
export const Reports: React.FC = () => {
 ...
 <div className="space-y-6 sm:space-y-8 lg:space-y-10">
  ...
  <div className="relative z-decorator">
   ...
   <div>
   <h3 className="text-lg font-bold text-foreground">{t('reports.templateCards.iso27001.title')}</h3>
  ...
  <div className="relative z-decorator">
   ...
   <div>
   <h3 className="text-lg font-bold text-foreground">{t('reports.templateCards.gdpr.title')}</h3>
  ...
  <div className="relative z-decorator">
   ...
   <div>
   <h3 className="text-lg font-bold text-foreground">{t('reports.templateCards.custom.title')}</h3>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
  ...
  <div key={doc.id || 'unknown'} className="glass-premium p-4 sm:p-6 rounded-3xl border border-border/40 hover:border-primary/60/50 transition-all duration-300 group">
  <div className="flex items-start justify-between mb-4">
   <div className="p-3 bg-muted rounded-xl text-muted-foreground">
   <FileText className="h-6 w-6" />
   </div>
   <span className={`px-2 py-1 rounded-lg text-xs font-bold ${doc.status === 'Publié' ? 'bg-success-bg text-success-text' : 'bg-muted text-muted-foreground'}`}>
   {doc.status}
   </span>
  </div>
 ...
 <div className="space-y-6">
  ...
  <div>
  <h2 className="text-lg font-bold text-foreground">{t('reports.scheduledSection.title')}</h2>
  <p className="text-sm text-muted-foreground">{t('reports.scheduledSection.subtitle')}</p>
  </div>
  ...
  >
   ...
   <h3 className="font-bold text-foreground mb-2 truncate" title={report.name}>
   {report.name}
   </h3>
   ...
   <>
    ...
    {t('reports.actions.pause', { defaultValue: 'Pause' })}
   </>
   ) : (
   <>
    <Play className="h-4 w-4 mr-1" />
    {t('reports.actions.activate', { defaultValue: 'Activer' })}
   </>
   )}
   </Button>
   <Button
  ...
  <h3 className="text-lg font-bold text-foreground mb-2">{t('reports.scheduledSection.emptyTitle')}</h3>
