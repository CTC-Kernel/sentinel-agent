...
export const ThreatRegistry: React.FC = () => {
 ...
 actions={
  ...
  className="bg-primary hover:bg-primary/90 text-primary-foreground px-5 py-2.5 rounded-xl flex items-center transition-all shadow-lg shadow-primary/20 text-sm font-bold"
  >
 ...
 <div className="glass-premium rounded-3xl border border-border dark:border-white/5 p-6 backdrop-blur-xl">
 ...
 <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
  ...
  className="bg-primary hover:bg-primary/90 text-white px-6 py-2 rounded-xl flex items-center shadow-lg shadow-primary/20 disabled:bg-muted disabled:text-muted-foreground"
  >
...
const ThreatRegistryCard = React.memo(({
 ...
 role="button"
 tabIndex={0}
 className="bg-muted/80 rounded-2xl p-6 border border-border/60 dark:border-white/5 hover:border-primary/40 transition-all duration-200 group relative overflow-hidden cursor-pointer hover:shadow-lg active:scale-[0.98]"
 >
 ...
 <h3 className="font-bold text-foreground mb-2 line-clamp-1">{threat.name}</h3>
 ...
 <div className="mt-4 pt-4 border-t border-border dark:border-white/5 flex justify-between items-center text-xs text-muted-foreground">
  <span>{threat.field}</span>
  <span className="flex items-center">
  Score Ref: <span className="font-bold text-primary ml-1">{threat.probability * threat.impact}</span>
  </span>
 </div>
 </div>
 </motion.div>
