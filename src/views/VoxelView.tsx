...
export const VoxelView: React.FC = () => {
 ...
 <div className="max-h-80 overflow-y-auto p-2">
  ...
  className={`w - full flex items - center gap - 3 px - 3 py - 2.5 rounded - xl text - left transition - all duration - 150 ${index === 0 ? 'bg-primary/15 border border-primary/40' : 'hover:bg-white/5'
  } `}
  >
