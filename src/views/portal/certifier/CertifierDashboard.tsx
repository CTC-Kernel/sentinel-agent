                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-start gap-4">
                                                    <div className="p-2 bg-brand-50 dark:bg-brand-900/20 text-brand-600 rounded-lg group-hover:bg-white group-hover:shadow-sm transition-all">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-white/5 p-4 shadow-sm">
                                ...
                                <div className="space-y-3">
                                    {data.clients.map(client => (
                                        <div key={client.id} className="flex items-center justify-between p-3 rounded-lg border border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 bg-slate-100 dark:bg-slate-700 rounded-full flex items-center justify-center text-slate-500 font-bold text-xs">
                            ...
                            <button className="w-full mt-4 py-2 text-sm text-brand-600 font-medium hover:bg-brand-50 dark:hover:bg-brand-900/20 rounded-lg transition-colors dashed border border-brand-200">
