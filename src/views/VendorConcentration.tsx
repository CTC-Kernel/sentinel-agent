...
const MetricCard: React.FC<MetricCardProps> = ({
 ...
 <Component
 className={`
 glass-premium p-5 rounded-2xl text-left w-full border border-border/40 shadow-sm
...
export const VendorConcentration: React.FC = () => {
 ...
 ${showFilters
  ? 'bg-primary/15 dark:bg-primary text-primary hover:bg-primary/20'
  : 'bg-muted text-muted-foreground hover:bg-muted'
 }
 `}
 ...
 className="flex items-center gap-2 px-3 sm:px-4 py-2 h-auto rounded-xl text-sm font-medium bg-muted text-muted-foreground hover:bg-muted transition-all disabled:bg-muted disabled:text-muted-foreground"
 ...
 <Button
 variant="default"
 className="flex items-center gap-2 px-3 sm:px-4 py-2 h-auto rounded-xl text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 transition-all"
 ...
 <div className="glass-premium p-4 sm:p-6 rounded-2xl lg:col-span-2 border border-border/40 shadow-sm">
 <h2 className="text-lg font-semibold text-foreground mb-4">
