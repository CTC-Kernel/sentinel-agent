...
export const TenantList: React.FC = () => {
 ...
 {[1, 2, 3].map(i => (
 <div key={i || 'unknown'} className="h-16 bg-muted/50 rounded-xl animate-pulse" />
 ))}
 </div>
 );
 ...
 <div className="flex gap-2">
  <button className="px-4 py-2 bg-muted hover:bg-muted/80 rounded-xl text-sm font-medium transition-colors flex items-center text-muted-foreground">
  <Filter className="w-4 h-4 mr-2" />
  Filter
  </button>
  <button className="px-4 py-2 bg-primary hover:bg-primary text-primary-foreground rounded-xl text-sm font-medium transition-colors shadow-lg shadow-primary/20">
  Add Tenant
  </button>
 </div>
 </div>
 ...
 <table className="w-full text-left border-collapse">
  ...
  <td className="px-6 py-4">
   ...
   <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-primary-foreground font-bold mr-3 shadow-lg shrink-0">
