                                    ...
                                    <tr key={org.id || 'unknown'} className="hover:bg-slate-50/80 dark:hover:bg-white/5 text-slate-700 dark:text-slate-300 transition-colors group">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <Button
                                                ...
                                                className="px-4 py-2 border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 font-bold hover:bg-brand-50 dark:hover:bg-brand-900 hover:text-brand-600 dark:hover:text-brand-400 hover:border-brand-200 dark:hover:border-brand-300 transition-all shadow-sm"
                                            >
