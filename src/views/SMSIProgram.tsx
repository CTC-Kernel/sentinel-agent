...
const SMSITimeline: React.FC<SMSITimelineProps> = ({ milestones, program, onSelect, getPhaseProgress }) => {
 ...
 isCurrentPhase ? `${style.borderActive} ${style.bgActive}` : "border-border"
 )}>
 ...
 <div className="flex-1">
  <div className="flex items-center gap-3">
  <h4 className={cn("font-bold", isCurrentPhase ? style.textActive : "text-foreground")}>
  {config.label}
  </h4>
  {isCurrentPhase && (
 ...
 <div className="ml-6 border-l-2 border-border pl-6 py-4">
