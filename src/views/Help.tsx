...
export const Help: React.FC = () => {
 ...
 <div className="flex h-[calc(100vh-16rem)] animate-fade-in overflow-hidden rounded-3xl glass-premium border border-border shadow-2xl relative">
 ...
 `}>
  ...
  className="w-full py-3 bg-foreground text-background rounded-xl text-sm font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
  >
 ...
 {/* Main Content Area */}
 <div className="flex-1 flex flex-col min-w-0 bg-card/50 relative backdrop-blur-sm">
  {/* Mobile Header */}
  ...
  <div className="flex items-center gap-4 mb-8">
   <div className="p-3 bg-primary/10 rounded-2xl ring-1 ring-primary/60">
   <activeCategory.icon className="w-8 h-8 text-primary" />
   </div>
   <div>
  ...
  <div className="grid gap-6">
   ...
   ? 'bg-primary/10 border-primary/30 dark:border-primary/40 ring-1 ring-primary/60'
   : 'bg-card/40 border-border hover:border-primary/40 dark:hover:border-primary/80 hover:shadow-lg hover:shadow-primary/25'
   }`}
   >
   <div
   ...
   <div className="flex-1">
    ...
    <h2 className={`text-lg font-bold transition-colors ${selectedArticle === article.id ? 'text-foreground' : 'text-foreground'
    }`}>
    {article.title}
    </h2>
    <ChevronDown className={`w-5 h-5 text-muted-foreground transition-transform duration-300 ${selectedArticle === article.id ? 'rotate-180 text-primary' : ''}`} />
    </div>
   ...
   <div className="overflow-hidden">
    ...
    <div className="h-px w-full bg-muted/50 mb-6" />
    ...
    <div className="text-sm text-muted-foreground leading-relaxed pl-3.5 border-l-2 border-primary/30 dark:border-primary/40">
     {section.content}
    </div>
    </div>
    ))}
