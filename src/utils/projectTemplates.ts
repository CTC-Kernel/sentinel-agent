...
export const PROJECT_TEMPLATES: ProjectTemplate[] = [
    ...
    },
    {
        ...
        defaultTasks: [
            { title: 'Revue des politiques de sécurité', description: 'Vérifier la pertinence des politiques', status: 'À faire', priority: 'medium', estimatedHours: 16 },
            { title: 'Mise à jour de l\'analyse de risques', description: 'Réévaluer les risques (ISO 27005)', status: 'À faire', priority: 'high', estimatedHours: 40 },
            { title: 'Campagne de sensibilisation annuelle', description: 'Relancer les formations', status: 'À faire', priority: 'medium', estimatedHours: 20 },
            { title: 'Revue des accès utilisateurs', description: 'Contrôle des droits d\'accès', status: 'À faire', priority: 'high', estimatedHours: 24 },
            { title: 'Test du plan de continuité (PCA)', description: 'Exercice de crise annuel', status: 'À faire', priority: 'high', estimatedHours: 16 },
            { title: 'Audit interne : Planification', description: 'Définir le périmètre et le planning', status: 'À faire', priority: 'medium', estimatedHours: 8 },
            { title: 'Audit interne : Exécution', description: 'Réaliser les entretiens et tests', status: 'À faire', priority: 'high', estimatedHours: 40 },
            { title: 'Revue de direction (Préparation)', description: 'Collecter les indicateurs et KPIs', status: 'À faire', priority: 'medium', estimatedHours: 16 },
            { title: 'Revue de direction (Réunion)', description: 'Tenir la réunion et rédiger le CR', status: 'À faire', priority: 'high', estimatedHours: 4 }
        ]
    },
    {
        ...
        defaultTasks: [
            { title: 'Établissement du contexte', description: 'Définir les critères d\'impact et d\'acceptation', status: 'À faire', priority: 'high', estimatedHours: 8 },
            { title: 'Identification des actifs (Mise à jour)', description: 'Revoir l\'inventaire des actifs', status: 'À faire', priority: 'medium', estimatedHours: 16 },
            { title: 'Identification des menaces', description: 'Lister les menaces potentielles', status: 'À faire', priority: 'high', estimatedHours: 12 },
            { title: 'Évaluation des risques', description: 'Estimer vraisemblance et impact', status: 'À faire', priority: 'high', estimatedHours: 24 },
            { title: 'Identification des contrôles existants', description: 'Évaluer l\'efficacité des mesures en place', status: 'À faire', priority: 'medium', estimatedHours: 16 },
            { title: 'Appréciation du risque résiduel', description: 'Calculer le niveau de risque net', status: 'À faire', priority: 'high', estimatedHours: 8 },
            { title: 'Définition du plan de traitement (RTP)', description: 'Choisir les options de traitement', status: 'À faire', priority: 'high', estimatedHours: 20 },
            { title: 'Acceptation des risques résiduels', description: 'Signature formelle par la direction', status: 'À faire', priority: 'high', estimatedHours: 4 }
        ]
    },
    {
        id: 'nis2-compliance',
        ...
        defaultTasks: [
            { title: 'Identification des services essentiels', description: 'Cartographier les activités critiques', status: 'À faire', priority: 'high', estimatedHours: 16 },
            { title: 'Déclaration auprès de l\'autorité', description: 'S\'enregistrer auprès de l\'ANSSI', status: 'À faire', priority: 'high', estimatedHours: 4 },
            { title: 'Gouvernance de la sécurité', description: 'Validation des politiques par la direction', status: 'À faire', priority: 'high', estimatedHours: 12 },
            { title: 'Sécurité de la chaîne d\'approvisionnement', description: 'Auditer les fournisseurs critiques', status: 'À faire', priority: 'high', estimatedHours: 40 },
            { title: 'Gestion des incidents', description: 'Mettre en place la procédure de signalement', status: 'À faire', priority: 'high', estimatedHours: 24 },
            { title: 'Hygiène informatique', description: 'MFA, Patch management, Sauvegardes', status: 'À faire', priority: 'high', estimatedHours: 32 },
            { title: 'Gestion de crise', description: 'Définir et tester le plan de crise', status: 'À faire', priority: 'medium', estimatedHours: 20 }
        ]
    },
    {
        id: 'dora-compliance',
        ...
        defaultTasks: [
            { title: 'Analyse d\'écart DORA', description: 'Gap analysis par rapport au règlement', status: 'À faire', priority: 'high', estimatedHours: 40 },
            { title: 'Gouvernance des risques TIC', description: 'Définir le cadre de gestion des risques', status: 'À faire', priority: 'high', estimatedHours: 24 },
            { title: 'Classification des incidents', description: 'Mettre à jour la procédure d\'incident', status: 'À faire', priority: 'high', estimatedHours: 16 },
            { title: 'Tests de résilience opérationnelle', description: 'Planifier les tests (vulnérabilité, intrusion)', status: 'À faire', priority: 'medium', estimatedHours: 32 },
            { title: 'Gestion des risques tiers', description: 'Recenser et évaluer les prestataires TIC', status: 'À faire', priority: 'high', estimatedHours: 48 },
            { title: 'Partage d\'information', description: 'Adhérer à des dispositifs de partage (CSIRT)', status: 'À faire', priority: 'low', estimatedHours: 8 }
        ]
    },
    {
        id: 'gdpr-compliance',
        ...
        defaultTasks: [
            { title: 'Cartographie des données', description: 'Identifier les données personnelles traitées', status: 'À faire', priority: 'high', estimatedHours: 24 },
            { title: 'Registre des traitements', description: 'Rédiger les fiches de registre', status: 'À faire', priority: 'high', estimatedHours: 32 },
            { title: 'Information des personnes', description: 'Mettre à jour les politiques de confidentialité', status: 'À faire', priority: 'medium', estimatedHours: 12 },
            { title: 'Gestion des sous-traitants', description: 'Vérifier les clauses RGPD des contrats', status: 'À faire', priority: 'medium', estimatedHours: 20 },
            { title: 'Sécurité des données', description: 'Vérifier les mesures techniques (chiffrement...)', status: 'À faire', priority: 'high', estimatedHours: 16 },
            { title: 'Procédure de violation', description: 'Définir le processus de notification CNIL', status: 'À faire', priority: 'high', estimatedHours: 8 }
        ]
    }
];
