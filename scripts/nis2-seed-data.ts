...
export const NIS2_FRAMEWORK: Omit<RegulatoryFramework, 'id' | 'createdAt' | 'updatedAt'> = {
  ...
  jurisdiction: 'EU',
  description: 'NIS2 Directive - Applicable sectors: energy, transport, banking, financial market, health, drinking water, wastewater, digital infrastructure, ICT service management, public administration, space, postal services, waste management, chemicals, food, manufacturing, digital providers, research',
