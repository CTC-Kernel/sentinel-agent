...
export const useGlobalShortcuts = () => {
    ...
    useHotkeys('ctrl+1,cmd+1', (e) => { e.preventDefault(); navigate('/'); addToast('Dashboard'); }, { enableOnFormTags: false });
    ...
    useHotkeys('ctrl+n,cmd+n', (e) => {
        ...
        if (path.includes('risks')) {
            ...
            addToast('Utilisez le bouton "Nouveau Risque" pour créer un élément', 'info');
        } else if (path.includes('assets')) {
            addToast('Utilisez le bouton "Nouvel Actif" pour créer un élément', 'info');
        } else {
            // Generic fallback or open command palette in "New" mode?
            // For now, simple toast
            addToast('Raccourci de création contextuel', 'info');
        }
    }, { enableOnFormTags: false });
    ...
    useHotkeys('ctrl+s,cmd+s', (e) => {
        ...
        addToast('Sauvegarde automatique active', 'success');
