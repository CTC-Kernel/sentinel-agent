...
static SIGMA_RULES: &[SigmaRule] = &[
    SigmaRule {
        ...
        patterns: &["sekurlsa", "logonpasswords", "lsadump", "procdump -ma lsass", "comsvcs.dll #24"],
    ...
    SigmaRule {
        ...
        patterns: &["-enc ", "-encodedcommand", "downloadstring", "invoke-expression", "iex(", "bypass -nop -w hidden"],
    ...
    SigmaRule {
        ...
        patterns: &["vssadmin delete shadows", "resize shadowstorage", "wmic shadowcopy delete", "wbadmin delete catalog"],
    ...
    SigmaRule {
        ...
        patterns: &["/dev/tcp/", "bash -i >&", "nc -e /bin/", "ncat -e /bin/sh", "mkfifo /tmp/"],
    ...
    SigmaRule {
        ...
        patterns: &["certutil -urlcache", "certutil.exe -urlcache -split -f", "bitsadmin /transfer"],
