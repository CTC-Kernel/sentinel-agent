...
pub(super) fn active_tactics(
    threats: &[super::types::ThreatEvent],
) -> std::collections::HashSet<MitreTactic> {
...
pub(super) fn mitre_minimap(ui: &mut egui::Ui, threats: &[super::types::ThreatEvent]) {
    ...
    widgets::card(ui, |ui: &mut egui::Ui| {
        ...
        let cell_w =
            (available_w - (all_tactics.len() as f32 - 1.0) * 2.0) / all_tactics.len() as f32;
        let cell_h = 28.0_f32;
