...
pub enum AgentEvent {
    ...
    LlmAnalysisComplete {
        ...
        /// AI-suggested remediation script (commands).
        ai_remediation_script: Option<Vec<String>>,
        /// AI-generated explanation for the remediation.
        ai_remediation_explanation: Option<String>,
    },
    ...
    /// LLM voice recognition state update.
    LlmVoiceState {
...
pub enum GuiCommand {
    ...
    ApplyAiRemediation {
        /// The full remediation action generated by the LLM.
