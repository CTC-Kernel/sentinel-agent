...
pub const SHIELD_CHECK: &str = SHIELD; // Free solid shield; f305 is a pen.
...
pub const EYE_SLASH: &str = "\u{f070}"; // fa-eye-slash
pub const MICROPHONE: &str = "\u{f130}"; // fa-microphone
pub const MICROPHONE_SLASH: &str = "\u{f131}"; // fa-microphone-slash
pub const CLIPBOARD: &str = "\u{f328}"; // fa-clipboard
pub const CLIPBOARD_CHECK: &str = "\u{f46c}"; // fa-clipboard-check
pub const CIRCLE_NOTCH: &str = "\u{f1ce}"; // fa-circle-notch (spinner alternative)
pub const EXCLAMATION: &str = "\u{f12a}"; // fa-exclamation
pub const HOUSE: &str = "\u{f015}"; // fa-house (alias for HOME)
pub const ARROW_LEFT: &str = "\u{f060}"; // fa-arrow-left
pub const ROTATE: &str = "\u{f2f1}"; // fa-rotate
