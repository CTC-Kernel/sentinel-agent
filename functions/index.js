...
const getJoinRequestEmailHtml = (requesterName, requesterEmail, orgName, link) => generateEmailHtml({
    ...
    <p>Veuillez examiner cette demande pour accorder ou refuser l'accès.</p>
  `,
...
const getRejectedEmailHtml = (userName, orgName) => generateEmailHtml({
    ...
    <p>Si vous pensez qu'il s'agit d'une erreur, veuillez contacter l'administrateur de l'organisation.</p>
  `
});
