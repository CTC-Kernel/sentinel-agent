...
const getJoinRequestEmailHtml = (requesterName, requesterEmail, orgName, link) => generateEmailHtml({
    ...
    <div class="highlight-box">
      <p style="margin: 0; font-size: 14px; color: #64748b;">Veuillez examiner cette demande pour accorder ou refuser l'accès.</p>
    </div>
  `,
...
const getApprovedEmailHtml = (userName, orgName, link) => generateEmailHtml({
    ...
    <div class="highlight-box">
      <p style="margin: 0; font-size: 14px; color: #64748b;">Vous pouvez maintenant accéder à votre espace de travail.</p>
    </div>
  `,
