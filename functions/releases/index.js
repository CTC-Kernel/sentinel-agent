...
const RELEASE_CONFIG = {
    agent: {
        ...
        platforms: {
            ...
            linux_deb: {
                filename: 'sentinel-agent_{version}-1_amd64.deb',
                latestFilename: 'sentinel-agent_latest_amd64.deb',
                checksumFilename: 'sentinel-agent_{version}-1_amd64.deb.sha256',
                contentType: 'application/vnd.debian.binary-package',
                displayName: 'Linux (DEB)',
            },
            linux_rpm: {
                filename: 'sentinel-agent-{version}-1.x86_64.rpm',
                latestFilename: 'sentinel-agent-latest.x86_64.rpm',
                checksumFilename: 'sentinel-agent-{version}-1.x86_64.rpm.sha256',
