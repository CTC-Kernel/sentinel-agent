...
inputDocuments:
  - market-grc-competitive-analysis-2026-01-20.md
  - brainstorming-verticaux-2026-01-20.md
date: 2026-01-20
author: Thibaultllopis
status: complete
---

# Product Brief: Sentinel-GRC

## Document de Stratégie Produit Consolidé

**Version:** 1.0
**Date:** 20 janvier 2026
**Auteur:** Thibaultllopis + Mary (Business Analyst)
...
Une vulnérabilité sur un serveur (Asset) impacte un processus métier, qui menace votre conformité DORA, qui engage votre responsabilité pénale. **Tout est lié. Tout est en 3D.**
...
> **"Governance. Risk. Command."**

---

# 2. Utilisateurs Cibles

## 2.1 Persona Primaire : Le RSSI Débordé
...
4. Protection de la réputation personnelle (responsabilité dirigeants)
...
PARCOURS D'ACHAT:
Besoin identifié → Recherche solutions → Short-list (3-4 vendors)
→ POC/Démo → Business case interne → Validation COMEX → Décision
```

## 2.2 Personas Secondaires par Vertical

### Finance : RSSI Banque/Assurance
...
```
┌─────────────────────────────────────────────────────────────────┐
│                 PARCOURS RSSI AVEC SENTINEL                     │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  AVANT                    PENDANT                  APRÈS        │
│  ─────                    ───────                  ─────        │
│                                                                 │
│  Excel fragmenté    →    Cartographie Voxel   →   Vision 360°   │
│  Analyses manuelles →    IA Gemini suggère    →   Anticipation  │
│  Conformité réactive →   Templates pré-remplis →  Proactivité   │
│  COMEX sceptique    →    Dashboard impact €   →   Budget validé │
│  Responsabilité floue →  Audit trail complet  →  Protection     │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
## 3.3 Métriques Produit

| Métrique | Target | Mesure |
|----------|--------|--------|
| Activation (first value) | < 7 jours | Premier dashboard créé |
...
## 4.2 Matrice Différenciation

| Critère | Sentinel | Egerie | Citalid | OneTrust | ServiceNow |
|---------|----------|--------|---------|----------|------------|
| **Visualisation 3D** | ✅ Voxel | ❌ | ❌ | ❌ | ❌ |
| **IA intégrée** | ✅ Gemini | ⚠️ Limité | ✅ CRQ | ⚠️ Add-on | ✅ Native |
| **EBIOS RM natif** | ✅ | ✅ | ❌ | ❌ | ❌ |
| **Souveraineté EU** | ✅ 100% | ✅ | ✅ | ❌ US | ❌ US |
| **Time-to-value** | < 8 sem | 3+ mois | 2+ mois | 6+ mois | 6+ mois |
| **Prix entrée** | €€ | €€€ | €€ | €€€€ | €€€€€ |

## 4.3 Angles d'Attaque par Concurrent

| Concurrent | Notre Angle |
|------------|-------------|
| **Egerie** | UX moderne + Voxel 3D (vs interface classique 2010) |
| **Citalid** | GRC complet (vs focus quantification seule) |
| **OneTrust** | Simplicité + souveraineté EU (vs complexité + US) |
| **ServiceNow** | Indépendance + spécialisation (vs lock-in écosystème) |
| **Vanta/Drata** | Profondeur EBIOS/NIS2 (vs focus SOC2/startup) |
| **Archer** | Modernité + time-to-value (vs legacy enterprise lourd) |
...
## 5.2 Roadmap Court Terme (Q1-Q2 2026)

| Feature | Priorité | Vertical cible |
|---------|----------|----------------|
| Registre ICT automatisé (DORA Art. 28) | P0 | Finance |
| Templates homologation ANSSI | P0 | Public |
| Connecteur SCADA/ICS | P1 | Industrie |
| Module Third-Party Risk | P1 | Tous |
| Quantification financière avancée | P1 | Tous |

## 5.3 Vision Long Terme (2026-2027)
...
## 6.1 Stratégie par Vertical

| Vertical | Approche | Message Principal | Canal |
|----------|----------|-------------------|-------|
| **Finance** | Direct + Partners | "DORA-Ready en 8 semaines" | Events ACPR, FFA |
| **Santé** | Références publiques | "Souveraineté + simplicité" | APSSIS, congrès DSI |
| **Industrie** | POC ciblés | "IT/OT unifié" | Salons industriels, CLUSIF |
| **Public** | Appels d'offres | "Homologation simplifiée" | UGAP, marchés publics |

## 6.2 Messaging Framework

### Headline Universel

> *"Arrêtez de remplir des cases. Commencez à protéger votre valeur."*

### Headlines Verticaux

| Vertical | Headline |
|----------|----------|
| Finance | "DORA entre en vigueur. Votre registre ICT est-il prêt ?" |
| Santé | "Vos données patients méritent mieux qu'un Excel et un hébergeur US." |
| Industrie | "Votre chaîne de production est connectée. Votre vision cyber aussi ?" |
| Public | "L'ANSSI exige l'homologation. Vos téléservices sont-ils prêts ?" |

### Taglines Verticaux

| Vertical | Tagline |
|----------|---------|
| Finance | "Sentinel-GRC. DORA-Ready depuis le premier jour." |
| Santé | "Sentinel-GRC. La santé de vos données, en toute souveraineté." |
| Industrie | "Sentinel-GRC. La résilience industrielle, du SCADA au COMEX." |
| Public | "Sentinel-GRC. L'homologation simplifiée pour le service public." |
...
| Dépendance Gemini | Moyenne | Moyen | Architecture multi-LLM |
| Complexité NIS2/DORA | Élevée | Positif | Opportunité de marché |

## 7.2 Hypothèses Critiques

| Hypothèse | Validation Requise |
|-----------|-------------------|
| RSSI prêts à payer pour visualisation 3D | A/B test messaging, 10 interviews |
| IA perçue comme augmentation vs remplacement | Feedback beta users |
| Souveraineté = critère décisif | Win/loss analysis |
| Time-to-value < 8 sem réaliste | Pilotes clients |

---

# 8. Annexes

## 8.1 Sources Documentaires

- **Recherche Concurrentielle:** `market-grc-competitive-analysis-2026-01-20.md`
- **Brainstorming Verticaux:** `brainstorming-verticaux-2026-01-20.md`
- **Données Marché:** IMARC, Gartner, Verdantix, Mordor Intelligence
- **Données RSSI:** Panorays 2026, ISACA, Evanta CISO Survey

## 8.2 Contacts Clés

| Rôle | Responsable |
|------|-------------|
| Product Owner | Thibaultllopis |
| Business Analyst | Mary (BMAD) |

---

**Document Status:** ✅ COMPLET
**Prochaine Étape:** PRD (Product Requirements Document)
