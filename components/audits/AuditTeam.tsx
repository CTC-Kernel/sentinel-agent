            ...
            <div className="bg-white dark:bg-slate-800/50 p-6 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm">
                <div className="flex justify-between items-center mb-4">
                    ...
                    {canEdit && !isAddingInternal && (
                        <button onClick={() => setIsAddingInternal(true)} className="text-xs font-bold text-brand-600 hover:text-brand-700 flex items-center">
                ...
                {isAddingInternal && (
                    <div className="mb-4 flex gap-2 animate-fade-in">
                        ...
                        <button onClick={handleAddInternal} className="px-3 bg-brand-600 text-white rounded-xl font-bold text-xs hover:bg-brand-700">OK</button>
                        <button onClick={() => setIsAddingInternal(false)} className="px-3 bg-slate-100 text-slate-600 rounded-xl font-bold text-xs hover:bg-slate-200">X</button>
                    </div>
                )}
            ...
            <div className="bg-white dark:bg-slate-800/50 p-6 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm">
                <div className="flex justify-between items-center mb-4">
                    ...
                    {canEdit && !isAddingExternal && (
                        <button onClick={() => setIsAddingExternal(true)} className="text-xs font-bold text-brand-600 hover:text-brand-700 flex items-center">
                ...
                {isAddingExternal && (
                    <div className="mb-4 flex gap-2 animate-fade-in">
                        ...
                        <button onClick={handleAddExternal} className="px-3 bg-brand-600 text-white rounded-xl font-bold text-xs hover:bg-brand-700">Inviter</button>
                        <button onClick={() => setIsAddingExternal(false)} className="px-3 bg-slate-100 text-slate-600 rounded-xl font-bold text-xs hover:bg-slate-200">X</button>
                    </div>
                )}
