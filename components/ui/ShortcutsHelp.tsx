                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-white/5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400">Gagnez du temps avec ces commandes</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <div key={idx} className="flex items-center justify-between group">
                            ...
                            <div className="flex items-center gap-1">
                                {shortcut.keys.map((key, i) => (
                                    <kbd
                                        key={i}
                                        className="min-w-[24px] px-2 py-1 flex items-center justify-center bg-slate-100 dark:bg-slate-800 border-b-2 border-slate-200 dark:border-slate-700 rounded-lg text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider font-mono"
                                    >
