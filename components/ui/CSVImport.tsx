...
export const CSVImport: React.FC<CSVImportProps> = ({ title, fields, onImport, onClose, templateData }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-fade-in">
            <div className="bg-white dark:bg-slate-850 rounded-[2rem] shadow-2xl w-full max-w-4xl border border-white/20 overflow-hidden animate-scale-in max-h-[90vh] flex flex-col">
                    ...
                    {step === 'upload' && (
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-between items-center p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                                ...
                                <button onClick={downloadTemplate} className="text-sm font-bold text-brand-600 dark:text-brand-400 hover:underline">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex gap-2">
                                    <button onClick={() => setStep('upload')} className="px-4 py-2 text-sm font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5 rounded-xl transition-colors">
                                        Annuler
                                    </button>
                                    <button
