...
export const CalendarDashboard: React.FC = () => {
    ...
    return (
        <div className="flex flex-col space-y-6 md:h-full">
            ...
            {/* Calendar */}
            <div className="flex-1 relative overflow-hidden rounded-[2rem] bg-white/80 dark:bg-slate-900/80 backdrop-blur-3xl shadow-2xl border border-white/20 dark:border-white/5 p-4 md:p-8 h-[800px] md:h-full min-h-[600px] group isolation-auto">
