...
describe('permissions', () => {
  ...
  describe('PERMISSIONS constant', () => {
    it('should export the role permission matrix', () => {
      expect(PERMISSIONS).toBeDefined();
      expect(PERMISSIONS.admin).toBeDefined();
      expect(PERMISSIONS.rssi).toBeDefined();
      expect(PERMISSIONS.auditor).toBeDefined();
      expect(PERMISSIONS.project_manager).toBeDefined();
      expect(PERMISSIONS.direction).toBeDefined();
