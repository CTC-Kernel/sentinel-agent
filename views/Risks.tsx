...
import { Plus, Trash2, Edit, Search, CheckCircle2, ShieldAlert, Filter, Server, ArrowRight, History, X, LayoutDashboard, FileSpreadsheet, Upload, MessageSquare, Flame, Clock, TrendingUp, TrendingDown, Copy, RefreshCw, Download, CalendarDays, FolderKanban } from '../components/ui/Icons';
...
export const Risks: React.FC = () => {
    ...
    const [inspectorTab, setInspectorTab] = useState<'details' | 'treatment' | 'projects' | 'history' | 'comments'>('details');
