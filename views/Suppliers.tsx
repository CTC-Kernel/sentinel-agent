  ...
  return (
    <div className="space-y-8 animate-fade-in pb-10 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {loading ? <div className="col-span-full text-center py-12 text-gray-400">Chargement...</div> : filteredSuppliers.length === 0 ? <div className="col-span-full text-center py-12 text-gray-400 italic">Aucun fournisseur trouvé.</div> : 
            filteredSuppliers.map(supplier => {
              ...
              return (
              <div key={supplier.id} onClick={() => openInspector(supplier)} className="glass-panel rounded-[2rem] border border-white/50 dark:border-white/5 p-7 shadow-sm hover:shadow-apple transition-all duration-300 hover:-translate-y-1 relative group cursor-pointer flex flex-col h-full">
