    ...
    <div className="space-y-8 animate-fade-in pb-10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loading ? <div className="col-span-full text-center py-12 text-gray-400">Chargement...</div> : 
             filteredAudits.length === 0 ? <div className="col-span-full text-center py-12 text-gray-400 italic">Aucun audit planifié.</div> :
             filteredAudits.map(audit => (
                 <div key={audit.id} onClick={() => handleOpenAudit(audit)} className="glass-panel rounded-[2rem] p-7 shadow-sm hover:shadow-apple transition-all duration-300 hover:-translate-y-1 cursor-pointer group border border-white/50 dark:border-white/5">
