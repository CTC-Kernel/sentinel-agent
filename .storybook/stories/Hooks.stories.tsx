...
import { useDoubleSubmitPrevention } from '../../src/hooks/useDoubleSubmitPrevention';
...
const ErrorHandlerDemoComponent = () => {
...
export const ErrorHandlerDemo: Story = {
  render: () => <ErrorHandlerDemoComponent />
};

const DoubleSubmitDemoComponent = () => {
...
export const DoubleSubmitDemo: Story = {
  render: () => <DoubleSubmitDemoComponent />
};
